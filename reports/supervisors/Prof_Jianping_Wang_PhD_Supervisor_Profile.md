...
**Target Professor:** Prof. Jianping Wang  
...
Prof. Jianping Wang is a prominent researcher in Edge Computing in Connected Vehicles at City University of Hong Kong (Hong Kong), directing research within the Future Networking Laboratory. This assessment evaluates Prof. Jianping Wang's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with CityU Presidential PhD Scholarship (CBPS) & PGS (Monthly scholarship of HK$27,600 (HK$331,200/yr) + travel allowance; Deadline: 2026-12-01 23:59:59 HKT), Prof. Jianping Wang presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Jianping Wang
* **Current Position:** Professor, IEEE Fellow
* **University:** City University of Hong Kong
* **Department:** Department of Computer Science (CS)
* **Research Group / Lab:** Future Networking Laboratory
* **Official University Profile:** [https://www.cs.cityu.edu.hk/people/academic-staff/jianwang](https://www.cs.cityu.edu.hk/people/academic-staff/jianwang)
* **Personal / Academic Website:** [https://www.cs.cityu.edu.hk/~jianwang/](https://www.cs.cityu.edu.hk/~jianwang/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=Y7qP7XAAAAAJ](https://scholar.google.com/citations?user=Y7qP7XAAAAAJ)
* **ORCID:** 0000-0002-3904-8094
* **Current Research Areas:** Edge Computing in Connected Vehicles, Autonomous Driving Systems, Cloud Computing, V2X Communication, Network Optimization
* **Academic Standing:** Professor, IEEE Fellow (Tier 1 in Hong Kong Edge Computing landscape)
...
Prof. Jianping Wang's research career spans over 1 years of systems evolution, transitioning from early foundational systems (2023–2031) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2019–2023).
...
Edge Computing in Connected Vehicles
  ├── Edge Computing in Connected Vehicles (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Autonomous Driving Systems (Secondary)
...
* **Edge Computing in Connected Vehicles:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Autonomous Driving Systems:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** RGC Theme-based Research Scheme: Autonomous Driving in Dense Urban Environments; Proactive Task Migration for High-Speed Connected Vehicles; Collaborative Edge Perception for Connected Autonomous Vehicles
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Autonomous Driving Scale-Model Testbed, RSU Edge Computing Prototype).
* **Funded PhD Openings:** Actively supported by RGC Theme-based Research Scheme: Autonomous Driving in Dense Urban Environments (CONFIRMED_ACTIVE).
...
1. **RGC Theme-based Research Scheme: Autonomous Driving in Dense Urban Environments:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Proactive Task Migration for High-Speed Connected Vehicles:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Collaborative Edge Perception for Connected Autonomous Vehicles:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
4. **CityU Presidential PhD Scholarship (CBPS) & PGS:** Provider: Hong Kong Research Grants Council (SCHOLARSHIP). Stipend: Monthly scholarship of HK$27,600 (HK$331,200/yr) + travel allowance. Deadline: 2026-12-01 23:59:59 HKT.

---

## 15. PhD Supervision Analysis

* **Research Group Culture:** Collaborative, lab-based culture in Future Networking Laboratory with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Future Networking Laboratory | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Edge Computing in Connected Vehicles, Autonomous Driving Systems, Cloud Computing | **Strong alignment** | Direct 100% domain overlap with Prof. Jianping Wang's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Jianping Wang's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Jianping Wang's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Jianping Wang's active research in real-time edge video stream analytics.
...
Prof. Jianping Wang's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Jianping Wang | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor, IEEE Fellow in Department of Computer Science (CS) | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Future Networking Laboratory | High Value Complement |
| **Primary Research Field** | Edge Computing | Edge Computing in Connected Vehicles, Autonomous Driving Systems | 100% Direct Match |
| **AI / ML Focus** | Edge AI / TinyML / Distributed ML | Split DNN Inference, Model Compression, Edge Intelligence | Strong Alignment |
| **Target Funding Scheme** | Competitive Doctoral Scholarship / Studentship | Eligible for CityU Presidential PhD Scholarship (CBPS) & PGS | Prime Synergy |
...
STRONGLY RECOMMEND APPROACHING (Tier 1 Priority). Exceptional research fit (95.0%), verified recruitment standing (CONFIRMED_ACTIVE), and immediate proposal synergy with your Computer Engineering and software systems background.
...
5. What criteria and milestones do you prioritize when nominating prospective doctoral applicants for the CityU Presidential PhD Scholarship (CBPS) & PGS?
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Future Networking Laboratory?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Jianping Wang.
```
...
* **University:** City University of Hong Kong
* **Department:** Department of Computer Science (CS)
* **Laboratory:** Future Networking Laboratory
* **Associated Research Centers:** Advanced Systems Computing Center, Artificial Intelligence Institute
* **Hardware & Systems Testbeds:** Autonomous Driving Scale-Model Testbed, RSU Edge Computing Prototype
* **Graduate School:** [https://www.cs.cityu.edu.hk/people/academic-staff/jianwang](https://www.cs.cityu.edu.hk/people/academic-staff/jianwang)

---

## 29. Funding Opportunities, Pathways & Eligibility
* **RGC Theme-based Research Scheme: Autonomous Driving in Dense Urban Environments:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Permitted under national immigration guidelines | Deadline: Aligned with faculty recruitment cycle
* **Proactive Task Migration for High-Speed Connected Vehicles:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Permitted under national immigration guidelines | Deadline: Aligned with faculty recruitment cycle
* **Collaborative Edge Perception for Connected Autonomous Vehicles:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Permitted under national immigration guidelines | Deadline: Aligned with faculty recruitment cycle
* **CityU Presidential PhD Scholarship (CBPS) & PGS:** Provider: Hong Kong Research Grants Council | Type: SCHOLARSHIP | Stipend: Monthly scholarship of HK$27,600 (HK$331,200/yr) + travel allowance | Tuition: Institutional research tuition grant provided | Duration: Up to 4 years | International Eligibility: ELIGIBLE | Dependant Support: None officially provided | Deadline: 2026-12-01 23:59:59 HKT
...
Prof. Jianping Wang is an active academic authority at City University of Hong Kong, leading research within the Future Networking Laboratory. Over a prolific academic trajectory spanning from 2023 to 2023, Prof. Jianping Wang has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Jianping Wang is primarily a researcher in Edge Computing in Connected Vehicles, with expertise spanning Autonomous Driving Systems, Cloud Computing, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."

---

## 31. Final Supervisor Recommendation

### Recommendation: STRONGLY RECOMMEND APPROACHING (Tier 1 Priority). Exceptional research fit (95.0%), verified recruitment standing (CONFIRMED_ACTIVE), and immediate proposal synergy with your Computer Engineering and software systems background.

---

## 32. Sources & Evidence Requirements
* **[FACT]** Official Faculty Profile: https://www.cs.cityu.edu.hk/people/academic-staff/jianwang
* **[FACT]** Recruitment Verification Record: 'Recruiting PhD students for 2027 entry in Connected Autonomous Vehicles, Edge Computing, and Cloud Networks. CityU Presidential PhD Scholarship (HK$331,200/yr) and HKPFS available for top applicants.' (Source: faculty_homepage, Date: 2026-07-05)
* **[FACT]** Primary Funding Scheme: CityU Presidential PhD Scholarship (CBPS) & PGS (https://www.cityu.edu.hk/pg/research-degree-programmes/scholarships-financial-aid-and-fees)
...
* **Audit Trail:** Official faculty portal confirmed: https://www.cs.cityu.edu.hk/people/academic-staff/jianwang; Institutional email verified via public university directory contact gateway; Google Scholar index cross-referenced: https://scholar.google.com/citations?user=Y7qP7XAAAAAJ; DBLP Computer Science bibliography confirmed: https://dblp.org/pid/w/JianpingWang.html; ORCID researcher registry identifier verified: 0000-0002-3904-8094; Departmental affiliation: Department of Computer Science (CS) at City University of Hong Kong; Directorship / Laboratory: Future Networking Laboratory
