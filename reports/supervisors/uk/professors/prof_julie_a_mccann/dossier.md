...
**Target Professor:** Prof. Julie A. McCann  
...
Prof. Julie A. McCann is a prominent researcher in Edge Computing at Imperial College London (United Kingdom), directing research within the Adaptive Embedded Systems / Resilient Information Systems Security (RISS). This assessment evaluates Prof. Julie A. McCann's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Imperial College President's PhD Scholarships (£25,150/year tax-free stipend + £2,000/year consumables fund; Deadline: 2026-11-06), Prof. Julie A. McCann presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Julie A. McCann
* **Current Position:** Professor of Computer Systems & Vice-Dean (Research)
* **University:** Imperial College London
* **Department:** Department of Computing
* **Research Group / Lab:** Adaptive Embedded Systems / Resilient Information Systems Security (RISS)
* **Official University Profile:** [https://www.imperial.ac.uk/people/j.mccann](https://www.imperial.ac.uk/people/j.mccann)
* **Personal / Academic Website:** [https://wp.doc.ic.ac.uk/riss/](https://wp.doc.ic.ac.uk/riss/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=X6_B-w8AAAAJ](https://scholar.google.com/citations?user=X6_B-w8AAAAJ)
* **ORCID:** 0000-0002-4523-8687
* **Current Research Areas:** Edge Computing, Low-Power Wireless Networks, Cyber-Physical Systems, Smart Cities Edge Sensing, Resilient Distributed Systems
* **Academic Standing:** Professor of Computer Systems & Vice-Dean (Research) (Tier 1 in United Kingdom Edge Computing landscape)
...
Prof. Julie A. McCann's research career spans over 1 years of systems evolution, transitioning from early foundational systems (2024–2032) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2020–2024).
...
Edge Computing
  ...
  ├── Low-Power Wireless Networks (Secondary)
...
* **Low-Power Wireless Networks:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** EPSRC Programme Grant; EU Horizon Edge Initiatives; Imperial College President's PhD Scholarships
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Imperial Smart Infrastructure Testbed, London Urban Edge Testbed).
* **Funded PhD Openings:** Actively supported by EPSRC Programme Grant (CONFIRMED_ACTIVE).
...
1. **EPSRC Programme Grant:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Adaptive Embedded Systems / Resilient Information Systems Security (RISS) with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Adaptive Embedded Systems / Resilient Information Systems Security (RISS) | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Edge Computing, Low-Power Wireless Networks, Cyber-Physical Systems | **Strong alignment** | Direct 100% domain overlap with Prof. Julie A. McCann's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Julie A. McCann's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Julie A. McCann's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Julie A. McCann's active research in real-time edge video stream analytics.
...
Prof. Julie A. McCann's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Julie A. McCann | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Computer Systems & Vice-Dean (Research) in Department of Computing | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Adaptive Embedded Systems / Resilient Information Systems Security (RISS) | High Value Complement |
| **Primary Research Field** | Edge Computing | Edge Computing, Low-Power Wireless Networks | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Adaptive Embedded Systems / Resilient Information Systems Security (RISS)?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Julie A. McCann.
```
...
* **University:** Imperial College London
* **Department:** Department of Computing
* **Laboratory:** Adaptive Embedded Systems / Resilient Information Systems Security (RISS)
...
* **Hardware & Systems Testbeds:** Imperial Smart Infrastructure Testbed, London Urban Edge Testbed
...
Prof. Julie A. McCann is an active academic authority at Imperial College London, leading research within the Adaptive Embedded Systems / Resilient Information Systems Security (RISS). Over a prolific academic trajectory spanning from 2024 to 2024, Prof. Julie A. McCann has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Julie A. McCann is primarily a researcher in Edge Computing, with expertise spanning Low-Power Wireless Networks, Cyber-Physical Systems, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."
...
* **[FACT]** Official Faculty Profile: https://www.imperial.ac.uk/people/j.mccann
* **[FACT]** Recruitment Verification Record: 'Recruiting PhD students annually across edge computing, low-power systems, and IoT network security through Imperial Computing doctoral admissions.' (Source: official_lab_website, Date: 2026-02-01)
