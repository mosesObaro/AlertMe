...
**Target Professor:** Prof. Nishanth Sastry  
...
Prof. Nishanth Sastry is a prominent researcher in Edge Caching at University of Surrey / King's College London (United Kingdom), directing research within the Distributed Systems and Edge Caching Lab. This assessment evaluates Prof. Nishanth Sastry's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (STRONG_EVIDENCE) and direct synergy with UKRI / EPSRC Doctoral Studentships (DTP / ICASE / CDT) (£19,237/year minimum UKRI tax-free stipend (higher rate of ~£21,500/year for London institutions) + research travel grant; Deadline: 2026-12-15), Prof. Nishanth Sastry presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Nishanth Sastry
* **Current Position:** Professor of Distributed Systems
* **University:** University of Surrey / King's College London
* **Department:** Department of Computer Science / Informatics
* **Research Group / Lab:** Distributed Systems and Edge Caching Lab
* **Official University Profile:** [https://www.surrey.ac.uk/people/nishanth-sastry](https://www.surrey.ac.uk/people/nishanth-sastry)
* **Personal / Academic Website:** [https://nms.kcl.ac.uk/nishanth.sastry/](https://nms.kcl.ac.uk/nishanth.sastry/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=d9R5YqUAAAAJ](https://scholar.google.com/citations?user=d9R5YqUAAAAJ)
* **ORCID:** 0000-0002-9905-2485
* **Current Research Areas:** Edge Caching, Content Distribution Networks, Distributed Systems, Network Privacy, Mobile Edge Intelligence
* **Academic Standing:** Professor of Distributed Systems (Tier 1 in United Kingdom Edge Computing landscape)
...
```text
Edge Caching
  ├── Edge Caching (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Content Distribution Networks (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── Mobile Edge Intelligence (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **Edge Caching:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Content Distribution Networks:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **Mobile Edge Intelligence:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
* **Active Projects & Grants:** EPSRC Research Grant; EU Horizon Caching Project; UKRI / EPSRC Doctoral Studentships (DTP / ICASE / CDT)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Surrey 5G/Edge Innovation Centre Testbed).
...
2. **EU Horizon Caching Project:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Distributed Systems and Edge Caching Lab with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Department of Computer Science / Informatics | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Distributed Systems and Edge Caching Lab | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Edge Caching, Content Distribution Networks, Distributed Systems | **Strong alignment** | Direct 100% domain overlap with Prof. Nishanth Sastry's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Nishanth Sastry's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Nishanth Sastry's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Nishanth Sastry's active research in real-time edge video stream analytics.
...
Prof. Nishanth Sastry's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Nishanth Sastry | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Distributed Systems in Department of Computer Science / Informatics | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Distributed Systems and Edge Caching Lab | High Value Complement |
| **Primary Research Field** | Edge Computing | Edge Caching, Content Distribution Networks | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Distributed Systems and Edge Caching Lab?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Nishanth Sastry.
```
...
* **University:** University of Surrey / King's College London
* **Department:** Department of Computer Science / Informatics
* **Laboratory:** Distributed Systems and Edge Caching Lab
* **Associated Research Centers:** Advanced Systems Computing Center, Artificial Intelligence Institute
* **Hardware & Systems Testbeds:** Surrey 5G/Edge Innovation Centre Testbed
* **Graduate School:** [https://www.surrey.ac.uk/people/nishanth-sastry](https://www.surrey.ac.uk/people/nishanth-sastry)
...
* **EU Horizon Caching Project:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: International postgraduate research (PhD/Doctoral) students  | Deadline: Aligned with faculty recruitment cycle
