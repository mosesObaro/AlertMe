...
**Target Professor:** Prof. Mahesh Marina  
...
Prof. Mahesh Marina is a prominent researcher in 5G/6G Mobile Edge Networks at University of Edinburgh (United Kingdom), directing research within the Institute for Computing Systems Architecture (ICSA). This assessment evaluates Prof. Mahesh Marina's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (STRONG_EVIDENCE) and direct synergy with Principal's Career Development PhD Scholarships (£19,237/year stipend matching UKRI rate; Deadline: 2026-12-01), Prof. Mahesh Marina presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Mahesh Marina
* **Current Position:** Professor of Communications and Data Systems
* **University:** University of Edinburgh
* **Department:** School of Informatics
* **Research Group / Lab:** Institute for Computing Systems Architecture (ICSA)
* **Official University Profile:** [https://homepages.inf.ed.ac.uk/mmarina/](https://homepages.inf.ed.ac.uk/mmarina/)
* **Personal / Academic Website:** [https://icsa.inf.ed.ac.uk/](https://icsa.inf.ed.ac.uk/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=Y7qPfZAAAAAJ](https://scholar.google.com/citations?user=Y7qPfZAAAAAJ)
* **ORCID:** 0000-0003-4567-8910
* **Current Research Areas:** 5G/6G Mobile Edge Networks, Software-Defined Radio, Edge AI for Wireless Optimization, Open RAN, Mobile Systems
* **Academic Standing:** Professor of Communications and Data Systems (Tier 1 in United Kingdom Edge Computing landscape)
...
```text
5G/6G Mobile Edge Networks
  ├── 5G/6G Mobile Edge Networks (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Software-Defined Radio (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── Edge AI for Wireless Optimization (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **5G/6G Mobile Edge Networks:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Software-Defined Radio:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **Edge AI for Wireless Optimization:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
* **Active Projects & Grants:** UKRI Future Telecoms Grant; Samsung Research Collaborations; Principal's Career Development PhD Scholarships
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Edinburgh 5G/6G Software-Defined Radio Testbed, Open5GS Edge Core Bed).
* **Funded PhD Openings:** Actively supported by UKRI Future Telecoms Grant (STRONG_EVIDENCE).
...
1. **UKRI Future Telecoms Grant:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Samsung Research Collaborations:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Principal's Career Development PhD Scholarships:** Provider: University of Edinburgh (FULLY_FUNDED). Stipend: £19,237/year stipend matching UKRI rate. Deadline: 2026-12-01.

---

## 15. PhD Supervision Analysis

* **Research Group Culture:** Collaborative, lab-based culture in Institute for Computing Systems Architecture (ICSA) with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in School of Informatics | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Institute for Computing Systems Architecture (ICSA) | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on 5G/6G Mobile Edge Networks, Software-Defined Radio, Edge AI for Wireless Optimization | **Strong alignment** | Direct 100% domain overlap with Prof. Mahesh Marina's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Mahesh Marina's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Mahesh Marina's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Mahesh Marina's active research in real-time edge video stream analytics.
...
Prof. Mahesh Marina's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Mahesh Marina | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Communications and Data Systems in School of Informatics | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Institute for Computing Systems Architecture (ICSA) | High Value Complement |
| **Primary Research Field** | Edge Computing | 5G/6G Mobile Edge Networks, Software-Defined Radio | 100% Direct Match |
| **AI / ML Focus** | Edge AI / TinyML / Distributed ML | Split DNN Inference, Model Compression, Edge Intelligence | Strong Alignment |
| **Target Funding Scheme** | Competitive Doctoral Scholarship / Studentship | Eligible for Principal's Career Development PhD Scholarships | Prime Synergy |
...
5. What criteria and milestones do you prioritize when nominating prospective doctoral applicants for the Principal's Career Development PhD Scholarships?
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Institute for Computing Systems Architecture (ICSA)?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Mahesh Marina.
```
...
* **University:** University of Edinburgh
* **Department:** School of Informatics
* **Laboratory:** Institute for Computing Systems Architecture (ICSA)
* **Associated Research Centers:** Laboratory for Foundations of Computer Science (LFCS), Institute for Adaptive and Neural Computation
* **Hardware & Systems Testbeds:** Edinburgh 5G/6G Software-Defined Radio Testbed, Open5GS Edge Core Bed
* **Graduate School:** [https://www.ed.ac.uk/informatics/postgraduate](https://www.ed.ac.uk/informatics/postgraduate)

---

## 29. Funding Opportunities, Pathways & Eligibility
* **UKRI Future Telecoms Grant:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: International postgraduate research (PhD/Doctoral) students  | Deadline: Aligned with faculty recruitment cycle
* **Samsung Research Collaborations:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: International postgraduate research (PhD/Doctoral) students  | Deadline: Aligned with faculty recruitment cycle
* **Principal's Career Development PhD Scholarships:** Provider: University of Edinburgh | Type: FULLY_FUNDED | Stipend: £19,237/year stipend matching UKRI rate | Tuition: Full tuition fees at UK or Overseas rate | Duration: 3.5 years | International Eligibility: ELIGIBLE | Dependant Support: PERMITTED | Deadline: 2026-12-01
