...
**Target Professor:** Prof. Wei Wang  
...
Prof. Wei Wang is a prominent researcher in Distributed Machine Learning at The Hong Kong University of Science and Technology (Hong Kong), directing research within the System Networking Lab (SING). This assessment evaluates Prof. Wei Wang's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with HKUST RedBird PhD Award & Postgraduate Studentship (PGS) (HK$40,000 recruitment award + full annual PGS of HK$220,680 (approx HK$18,390/mo); Deadline: 2026-12-01 23:59:59 HKT), Prof. Wei Wang presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Wei Wang
* **Current Position:** Associate Professor
* **University:** The Hong Kong University of Science and Technology
* **Department:** Department of Computer Science and Engineering (CSE)
* **Research Group / Lab:** System Networking Lab (SING)
* **Official University Profile:** [https://cse.hkust.edu.hk/admin/people/faculty/profile/weiwa](https://cse.hkust.edu.hk/admin/people/faculty/profile/weiwa)
* **Personal / Academic Website:** [https://home.cse.ust.hk/~weiwa/](https://home.cse.ust.hk/~weiwa/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=51cZ3sQAAAAJ](https://scholar.google.com/citations?user=51cZ3sQAAAAJ)
* **ORCID:** 0000-0001-6677-3323
* **Current Research Areas:** Distributed Machine Learning, Edge Intelligence, Cloud-Edge Systems, Federated Learning Systems, GPU Cluster Scheduling
...
* **Edge Intelligence:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** Efficient Distributed Training on Heterogeneous Cloud-Edge GPU Clusters; Communication-Efficient Federated Learning Frameworks for IoT; Inference Acceleration for Large Language Models on Edge Devices
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (128-GPU High Performance Cluster, Heterogeneous Edge Devices (Jetson Nano, Xavier, Orin, Raspberry Pi)).
* **Funded PhD Openings:** Actively supported by Efficient Distributed Training on Heterogeneous Cloud-Edge GPU Clusters (CONFIRMED_ACTIVE).
...
1. **Efficient Distributed Training on Heterogeneous Cloud-Edge GPU Clusters:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Communication-Efficient Federated Learning Frameworks for IoT:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Inference Acceleration for Large Language Models on Edge Devices:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
4. **HKUST RedBird PhD Award & Postgraduate Studentship (PGS):** Provider: Research Grants Council (RGC) / University (STIPEND_ONLY). Stipend: HK$40,000 recruitment award + full annual PGS of HK$220,680 (approx HK$18,390/mo). Deadline: 2026-12-01 23:59:59 HKT.

---

## 15. PhD Supervision Analysis

* **Research Group Culture:** Collaborative, lab-based culture in System Networking Lab (SING) with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in System Networking Lab (SING) | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Distributed Machine Learning, Edge Intelligence, Cloud-Edge Systems | **Strong alignment** | Direct 100% domain overlap with Prof. Wei Wang's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Wei Wang's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Wei Wang's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Wei Wang's active research in real-time edge video stream analytics.
...
Prof. Wei Wang's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Wei Wang | Evaluated Fit |
| :--- | :--- | :--- | :--- |
...
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in System Networking Lab (SING) | High Value Complement |
| **Primary Research Field** | Edge Computing | Distributed Machine Learning, Edge Intelligence | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in System Networking Lab (SING)?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Wei Wang.
```
...
* **Associated Research Centers:** System Networking Lab (SING), Huawei-HKUST Joint Innovation Laboratory, HKUST Big Data Institute (BDI)
* **Hardware & Systems Testbeds:** 128-GPU High Performance Cluster, Heterogeneous Edge Devices (Jetson Nano, Xavier, Orin, Raspberry Pi)
* **Graduate School:** [https://fytgs.hkust.edu.hk/](https://fytgs.hkust.edu.hk/)

---

## 29. Funding Opportunities, Pathways & Eligibility
* **Efficient Distributed Training on Heterogeneous Cloud-Edge GPU Clusters:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Full-time doctoral students in Hong Kong may sponsor legal s | Deadline: Aligned with faculty recruitment cycle
* **Communication-Efficient Federated Learning Frameworks for IoT:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Full-time doctoral students in Hong Kong may sponsor legal s | Deadline: Aligned with faculty recruitment cycle
* **Inference Acceleration for Large Language Models on Edge Devices:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Full-time doctoral students in Hong Kong may sponsor legal s | Deadline: Aligned with faculty recruitment cycle
* **HKUST RedBird PhD Award & Postgraduate Studentship (PGS):** Provider: Research Grants Council (RGC) / University | Type: STIPEND_ONLY | Stipend: HK$40,000 recruitment award + full annual PGS of HK$220,680 (approx HK$18,390/mo) | Tuition: Tuition scholarship available for HKPFS recipients (HK$42,100/yr) | Duration: 4 years (standard 4-year PhD) | International Eligibility: ELIGIBLE | Dependant Support: PERMITTED | Deadline: 2026-12-01 23:59:59 HKT
