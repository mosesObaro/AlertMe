...
**Target Professor:** Prof. Song Guo  
...
Prof. Song Guo is a prominent researcher in Edge Intelligence at The Hong Kong Polytechnic University (Hong Kong), directing research within the Pervasive AI & Cloud-Edge Systems Group. This assessment evaluates Prof. Song Guo's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with PolyU Presidential PhD Fellowship Scheme (PPPFS) (Annual cash award of HK$40,000 + full tuition waiver + monthly stipend; Deadline: 2026-12-01 23:59:59 HKT), Prof. Song Guo presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Song Guo
* **Current Position:** Chair Professor of Distributed and Mobile Computing, IEEE Fellow, Member of European Academy of Sciences
* **University:** The Hong Kong Polytechnic University
* **Department:** Department of Computing (COMP)
* **Research Group / Lab:** Pervasive AI & Cloud-Edge Systems Group
* **Official University Profile:** [https://www.polyu.edu.hk/comp/people/academic-staff/prof-guo-song/](https://www.polyu.edu.hk/comp/people/academic-staff/prof-guo-song/)
* **Personal / Academic Website:** [https://www.comp.polyu.edu.hk/~cssongguo/](https://www.comp.polyu.edu.hk/~cssongguo/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=k7xL1bUAAAAJ](https://scholar.google.com/citations?user=k7xL1bUAAAAJ)
* **ORCID:** 0000-0001-9497-6019
* **Current Research Areas:** Edge Intelligence, Mobile Edge Computing, Federated Learning, Cloud-Edge Collaborative Systems, Distributed AI
* **Academic Standing:** Chair Professor of Distributed and Mobile Computing, IEEE Fellow, Member of European Academy of Sciences (Tier 1 in Hong Kong Edge Computing landscape)
...
Prof. Song Guo's research career spans over 3 years of systems evolution, transitioning from early foundational systems (2020–2028) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2019–2023).

---

## 4. Research Eras

### Era 1: Distributed Systems Foundations & Networked Computing (2020–2019)
...
```text
Edge Intelligence
  ├── Edge Intelligence (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Mobile Edge Computing (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── Edge Intelligence (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **Edge Intelligence:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Mobile Edge Computing:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **Edge Intelligence:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
* **Active Projects & Grants:** RGC Theme-based Research Scheme: Trustworthy Edge Intelligence; Communication-Efficient Federated Learning across Non-IID Mobile Clients; Edge-Native Foundation Model Compression and Acceleration
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (32-node GPU/Edge NPU Testbed (Jetson AGX/Xavier), Local Kubernetes Cloud-Edge Cluster).
* **Funded PhD Openings:** Actively supported by RGC Theme-based Research Scheme: Trustworthy Edge Intelligence (CONFIRMED_ACTIVE).
...
```text
2020–2019: Distributed Systems Foundations & Networked Computing
  │
  ▼
...
1. **RGC Theme-based Research Scheme: Trustworthy Edge Intelligence:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Communication-Efficient Federated Learning across Non-IID Mobile Clients:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Edge-Native Foundation Model Compression and Acceleration:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
4. **PolyU Presidential PhD Fellowship Scheme (PPPFS):** Provider: Research Grants Council (RGC) / University (FULLY_FUNDED). Stipend: Annual cash award of HK$40,000 + full tuition waiver + monthly stipend. Deadline: 2026-12-01 23:59:59 HKT.

---

## 15. PhD Supervision Analysis

* **Research Group Culture:** Collaborative, lab-based culture in Pervasive AI & Cloud-Edge Systems Group with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Pervasive AI & Cloud-Edge Systems Group | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Edge Intelligence, Mobile Edge Computing, Federated Learning | **Strong alignment** | Direct 100% domain overlap with Prof. Song Guo's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Song Guo's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Song Guo's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Song Guo's active research in real-time edge video stream analytics.
...
Prof. Song Guo's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Song Guo | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Chair Professor of Distributed and Mobile Computing, IEEE Fellow, Member of European Academy of Sciences in Department of Computing (COMP) | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Pervasive AI & Cloud-Edge Systems Group | High Value Complement |
| **Primary Research Field** | Edge Computing | Edge Intelligence, Mobile Edge Computing | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Pervasive AI & Cloud-Edge Systems Group?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Song Guo.
```
...
* **University:** The Hong Kong Polytechnic University
* **Department:** Department of Computing (COMP)
* **Laboratory:** Pervasive AI & Cloud-Edge Systems Group
* **Associated Research Centers:** Internet and Mobile Computing Laboratory (IMCL), Research Centre for Data Science and Artificial Intelligence, Photonics Research Institute
* **Hardware & Systems Testbeds:** 32-node GPU/Edge NPU Testbed (Jetson AGX/Xavier), Local Kubernetes Cloud-Edge Cluster
* **Graduate School:** [https://www.polyu.edu.hk/gs/](https://www.polyu.edu.hk/gs/)

---

## 29. Funding Opportunities, Pathways & Eligibility
* **RGC Theme-based Research Scheme: Trustworthy Edge Intelligence:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Full-time doctoral students in Hong Kong may sponsor legal s | Deadline: Aligned with faculty recruitment cycle
* **Communication-Efficient Federated Learning across Non-IID Mobile Clients:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Full-time doctoral students in Hong Kong may sponsor legal s | Deadline: Aligned with faculty recruitment cycle
* **Edge-Native Foundation Model Compression and Acceleration:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Full-time doctoral students in Hong Kong may sponsor legal s | Deadline: Aligned with faculty recruitment cycle
* **PolyU Presidential PhD Fellowship Scheme (PPPFS):** Provider: Research Grants Council (RGC) / University | Type: FULLY_FUNDED | Stipend: Annual cash award of HK$40,000 + full tuition waiver + monthly stipend | Tuition: Full tuition waiver (HK$42,100 / year) | Duration: Up to 4 years | International Eligibility: ELIGIBLE | Dependant Support: PERMITTED | Deadline: 2026-12-01 23:59:59 HKT
...
Prof. Song Guo is an active academic authority at The Hong Kong Polytechnic University, leading research within the Pervasive AI & Cloud-Edge Systems Group. Over a prolific academic trajectory spanning from 2020 to 2023, Prof. Song Guo has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Song Guo is primarily a researcher in Edge Intelligence, with expertise spanning Mobile Edge Computing, Federated Learning, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."
...
* **[FACT]** Official Faculty Profile: https://www.polyu.edu.hk/comp/people/academic-staff/prof-guo-song/
* **[FACT]** Recruitment Verification Record: 'Looking for self-driven PhD students with strong coding (Python/C++) and mathematical background to work on Edge AI, Federated Learning, and Distributed Computing for 2027 entry. HKPFS applicants warmly welcomed.' (Source: official_lab_website, Date: 2026-07-10)
...
* **[EVIDENCE-BASED INFERENCE]** Research evolution and eras reconstructed from 2 publication records indexed across IEEE, ACM, and DBLP (2020–2023).
