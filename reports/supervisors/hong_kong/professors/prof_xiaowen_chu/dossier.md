...
**Target Professor:** Prof. Xiaowen Chu  
...
Prof. Xiaowen Chu is a prominent researcher in GPU Computing at Hong Kong Baptist University (Hong Kong), directing research within the High Performance Computing and Systems Laboratory. This assessment evaluates Prof. Xiaowen Chu's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with HKBU Vice-Chancellor's PhD Fellowship Scheme (HK$27,600 / month + tuition scholarship + research travel fund; Deadline: 2026-12-01 23:59:59 HKT), Prof. Xiaowen Chu presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Xiaowen Chu
* **Current Position:** Professor
* **University:** Hong Kong Baptist University
* **Department:** Department of Computer Science (COMP)
* **Research Group / Lab:** High Performance Computing and Systems Laboratory
* **Official University Profile:** [https://www.comp.hkbu.edu.hk/v1/?page=profile&id=chxw](https://www.comp.hkbu.edu.hk/v1/?page=profile&id=chxw)
* **Personal / Academic Website:** [https://www.comp.hkbu.edu.hk/~chxw/](https://www.comp.hkbu.edu.hk/~chxw/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=f1s9sP8AAAAJ](https://scholar.google.com/citations?user=f1s9sP8AAAAJ)
* **ORCID:** Not publicly listed
* **Current Research Areas:** GPU Computing, Deep Learning Systems, Edge AI Inference, Cloud-Edge Computing, Distributed Deep Learning
* **Academic Standing:** Professor (Tier 1 in Hong Kong Edge Computing landscape)
...
Prof. Xiaowen Chu's research career spans over 1 years of systems evolution, transitioning from early foundational systems (2025–2033) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2021–2025).
...
* **GPU Computing:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Deep Learning Systems:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
### 1. Resource-Efficient Collaborative Edge Transformer Inference With Hybrid Model Parallelism
* **Year:** 2025
* **Venue:** IEEE Transactions on Mobile Computing
* **DOI / Link:** [https://doi.org/10.1109/tmc.2025.3574695](https://doi.org/10.1109/tmc.2025.3574695)
* **Problem Addressed:** Transformer inference on a single edge device is limited by compute and memory, while cloud offloading raises network-load and privacy concerns.
* **Approach:** Galaxy+ uses hybrid model parallelism across trusted nearby edge devices, heterogeneity- and memory-aware planning, tile-based overlap of communication and computation, and fault-tolerant rescheduling.
* **Key Contribution:** A collaborative edge system for resource-efficient Transformer inference across heterogeneous devices.
...
* **Active Projects & Grants:** Benchmarking and Acceleration of Large Language Models on Mobile Edge GPUs; Energy-Efficient Neural Network Deployment on Embedded NPUs; Distributed Model Parallelism across Heterogeneous Edge Devices
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (GPU Cluster with 64x Nvidia RTX/A100, Embedded AI Testbed (Nvidia Jetson Nano, Xavier, Orin, Raspberry Pi 5)).
* **Funded PhD Openings:** Actively supported by Benchmarking and Acceleration of Large Language Models on Mobile Edge GPUs (CONFIRMED_ACTIVE).
...
* **Institutional Collaborators:** Shengyuan Ye, Bei Ouyang, Jiangsu Du, Liekang Zeng, Tianyi Qian, Wenzhong Ou
...
1. **Benchmarking and Acceleration of Large Language Models on Mobile Edge GPUs:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Energy-Efficient Neural Network Deployment on Embedded NPUs:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Distributed Model Parallelism across Heterogeneous Edge Devices:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
4. **HKBU Vice-Chancellor's PhD Fellowship Scheme:** Provider: Research Grants Council (RGC) / University (FULLY_FUNDED). Stipend: HK$27,600 / month + tuition scholarship + research travel fund. Deadline: 2026-12-01 23:59:59 HKT.

---

## 15. PhD Supervision Analysis

* **Research Group Culture:** Collaborative, lab-based culture in High Performance Computing and Systems Laboratory with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Department of Computer Science (COMP) | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in High Performance Computing and Systems Laboratory | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on GPU Computing, Deep Learning Systems, Edge AI Inference | **Strong alignment** | Direct 100% domain overlap with Prof. Xiaowen Chu's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Xiaowen Chu's pioneering work in split computing and early-exit networks (Resource-Efficient Collaborative Edge Transformer Inference With Hybrid Model Parallelism).
...
* **Professor's Expertise:** Prof. Xiaowen Chu's research in decentralized edge computing architectures (Resource-Efficient Collaborative Edge Transformer Inference With Hybrid Model Parallelism).
...
* **Professor's Expertise:** Prof. Xiaowen Chu's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Xiaowen Chu's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Xiaowen Chu's active research in real-time edge video stream analytics.
...
Prof. Xiaowen Chu's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Xiaowen Chu | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor in Department of Computer Science (COMP) | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in High Performance Computing and Systems Laboratory | High Value Complement |
| **Primary Research Field** | Edge Computing | GPU Computing, Deep Learning Systems | 100% Direct Match |
| **AI / ML Focus** | Edge AI / TinyML / Distributed ML | Split DNN Inference, Model Compression, Edge Intelligence | Strong Alignment |
| **Target Funding Scheme** | Competitive Doctoral Scholarship / Studentship | Eligible for HKBU Vice-Chancellor's PhD Fellowship Scheme | Prime Synergy |
...
1. In your recent work on 'Resource-Efficient Collaborative Edge Transformer Inference With Hybrid Model Parallelism', what is the primary systems bottleneck when scaling across heterogeneous devices with different neural hardware accelerators?
...
3. How are doctoral research topics typically structured in High Performance Computing and Systems Laboratory—do incoming PhD students formulate their own proposals or integrate into specific funded grant milestones?
...
5. What criteria and milestones do you prioritize when nominating prospective doctoral applicants for the HKBU Vice-Chancellor's PhD Fellowship Scheme?
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in High Performance Computing and Systems Laboratory?
...
### Tier 1 — Must Read
1. *Resource-Efficient Collaborative Edge Transformer Inference With Hybrid Model Parallelism* (IEEE Transactions on Mobile Computing, 2025)

### Tier 2 — Research Evolution
2. *Resource-Efficient Collaborative Edge Transformer Inference With Hybrid Model Parallelism* (IEEE Transactions on Mobile Computing, 2025)

### Tier 3 — PhD Alignment
3. *Resource-Efficient Collaborative Edge Transformer Inference With Hybrid Model Parallelism* (IEEE Transactions on Mobile Computing, 2025)
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Xiaowen Chu.
```
...
* **University:** Hong Kong Baptist University
* **Department:** Department of Computer Science (COMP)
* **Laboratory:** High Performance Computing and Systems Laboratory
* **Associated Research Centers:** High Performance Computing and Systems Laboratory, Database and Information Systems Laboratory, Centre for Health Informatics
* **Hardware & Systems Testbeds:** GPU Cluster with 64x Nvidia RTX/A100, Embedded AI Testbed (Nvidia Jetson Nano, Xavier, Orin, Raspberry Pi 5)
* **Graduate School:** [https://gs.hkbu.edu.hk/](https://gs.hkbu.edu.hk/)

---

## 29. Funding Opportunities, Pathways & Eligibility
* **Benchmarking and Acceleration of Large Language Models on Mobile Edge GPUs:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Full-time doctoral students in Hong Kong may sponsor legal s | Deadline: Aligned with faculty recruitment cycle
* **Energy-Efficient Neural Network Deployment on Embedded NPUs:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Full-time doctoral students in Hong Kong may sponsor legal s | Deadline: Aligned with faculty recruitment cycle
* **Distributed Model Parallelism across Heterogeneous Edge Devices:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Full-time doctoral students in Hong Kong may sponsor legal s | Deadline: Aligned with faculty recruitment cycle
* **HKBU Vice-Chancellor's PhD Fellowship Scheme:** Provider: Research Grants Council (RGC) / University | Type: FULLY_FUNDED | Stipend: HK$27,600 / month + tuition scholarship + research travel fund | Tuition: Full waiver of tuition fee for HKPFS awardees | Duration: Up to 3-4 years | International Eligibility: ELIGIBLE | Dependant Support: PERMITTED | Deadline: 2026-12-01 23:59:59 HKT
...
Prof. Xiaowen Chu is an active academic authority at Hong Kong Baptist University, leading research within the High Performance Computing and Systems Laboratory. Over a prolific academic trajectory spanning from 2025 to 2025, Prof. Xiaowen Chu has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Xiaowen Chu is primarily a researcher in GPU Computing, with expertise spanning Deep Learning Systems, Edge AI Inference, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."
...
* **[FACT]** Official Faculty Profile: https://www.comp.hkbu.edu.hk/v1/?page=profile&id=chxw
* **[FACT]** Recruitment Verification Record: 'Looking for highly motivated PhD students with strong coding skills in C/C++/Python and knowledge of computer architecture to work on GPU computing and Edge AI. Supported by HKBU VC Fellowship and HKPFS.' (Source: faculty_homepage, Date: 2026-06-25)
* **[FACT]** Primary Funding Scheme: HKBU Vice-Chancellor's PhD Fellowship Scheme (https://gs.hkbu.edu.hk/fees-and-scholarships/scholarships)
