...
**Target Professor:** Prof. John C.S. Lui  
...
Prof. John C.S. Lui is a prominent researcher in Network Systems at The Chinese University of Hong Kong (Hong Kong), directing research within the Advanced Networking and System Research Laboratory. This assessment evaluates Prof. John C.S. Lui's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (STRONG_EVIDENCE) and direct synergy with CUHK Vice-Chancellor's PhD Scholarship Scheme (HK$40,000 - HK$80,000 award + tuition waiver + full studentship; Deadline: 2026-12-01 23:59:59 HKT), Prof. John C.S. Lui presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. John C.S. Lui
* **Current Position:** Choh-Ming Li Professor of Computer Science and Engineering, ACM Fellow, IEEE Fellow
* **University:** The Chinese University of Hong Kong
* **Department:** Department of Computer Science and Engineering (CSE)
* **Research Group / Lab:** Advanced Networking and System Research Laboratory
* **Official University Profile:** [https://www.cse.cuhk.edu.hk/people/faculty/john-c-s-lui/](https://www.cse.cuhk.edu.hk/people/faculty/john-c-s-lui/)
* **Personal / Academic Website:** [https://www.cse.cuhk.edu.hk/~cslui/](https://www.cse.cuhk.edu.hk/~cslui/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=k3B5GvYAAAAJ](https://scholar.google.com/citations?user=k3B5GvYAAAAJ)
* **ORCID:** 0000-0002-3860-9099
* **Current Research Areas:** Network Systems, Edge Caching, Reinforcement Learning in Networking, Stochastic Modeling, Cybersecurity
* **Academic Standing:** Choh-Ming Li Professor of Computer Science and Engineering, ACM Fellow, IEEE Fellow (Tier 1 in Hong Kong Edge Computing landscape)
...
* **Network Systems:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Edge Caching:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** Multi-Agent Reinforcement Learning for Dynamic Edge Spectrum Sharing; Security and Robustness of Cooperative Edge Caching Systems; Stochastic Modeling of 5G/6G URLLC Edge Workloads
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Campus Wide-Area Testbed, High-Performance Emulation Clusters).
* **Funded PhD Openings:** Actively supported by Multi-Agent Reinforcement Learning for Dynamic Edge Spectrum Sharing (STRONG_EVIDENCE).
...
1. **Multi-Agent Reinforcement Learning for Dynamic Edge Spectrum Sharing:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Security and Robustness of Cooperative Edge Caching Systems:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Stochastic Modeling of 5G/6G URLLC Edge Workloads:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Advanced Networking and System Research Laboratory with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Department of Computer Science and Engineering (CSE) | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Advanced Networking and System Research Laboratory | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Network Systems, Edge Caching, Reinforcement Learning in Networking | **Strong alignment** | Direct 100% domain overlap with Prof. John C.S. Lui's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. John C.S. Lui's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. John C.S. Lui's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. John C.S. Lui's active research in real-time edge video stream analytics.
...
Prof. John C.S. Lui's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. John C.S. Lui | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Choh-Ming Li Professor of Computer Science and Engineering, ACM Fellow, IEEE Fellow in Department of Computer Science and Engineering (CSE) | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Advanced Networking and System Research Laboratory | High Value Complement |
| **Primary Research Field** | Edge Computing | Network Systems, Edge Caching | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Advanced Networking and System Research Laboratory?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. John C.S. Lui.
```
...
* **University:** The Chinese University of Hong Kong
* **Department:** Department of Computer Science and Engineering (CSE)
* **Laboratory:** Advanced Networking and System Research Laboratory
