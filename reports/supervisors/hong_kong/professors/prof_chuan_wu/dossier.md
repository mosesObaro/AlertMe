...
**Target Professor:** Prof. Chuan Wu  
...
Prof. Chuan Wu is a prominent researcher in Cloud and Edge Computing at The University of Hong Kong (Hong Kong), directing research within the Systems Research Group. This assessment evaluates Prof. Chuan Wu's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with HKU Presidential PhD Scholarship (HKU-PS) (Up to HK$441,400 in Year 1 (Cash award + PGS + travel subsidy); Deadline: 2026-12-01 23:59:59 HKT), Prof. Chuan Wu presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Chuan Wu
* **Current Position:** Professor
* **University:** The University of Hong Kong
* **Department:** Department of Computer Science (CS)
* **Research Group / Lab:** Systems Research Group
* **Official University Profile:** [https://www.cs.hku.hk/people/academic-staff/cwu](https://www.cs.hku.hk/people/academic-staff/cwu)
* **Personal / Academic Website:** [https://i.cs.hku.hk/~cwu/](https://i.cs.hku.hk/~cwu/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=G664B9kAAAAJ](https://scholar.google.com/citations?user=G664B9kAAAAJ)
* **ORCID:** 0000-0003-3482-6268
* **Current Research Areas:** Cloud and Edge Computing, Distributed Machine Learning Systems, Resource Scheduling, GPU Clustering, Federated Learning
...
Cloud and Edge Computing
  ├── Cloud and Edge Computing (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Distributed Machine Learning Systems (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── Federated Learning (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **Cloud and Edge Computing:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Distributed Machine Learning Systems:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **Federated Learning:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
* **Active Projects & Grants:** RGC GRF: Efficient Inference Serving of Foundation Models over Edge Networks; Pipelined Collaborative Learning across Heterogeneous Mobile Edge Devices; Fair Scheduling of Distributed Machine Learning Jobs in Hybrid Cloud-Edge
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (HKU GPU Cluster (Nvidia A100/H100), Edge AI Testbed (Jetson AGX Orin)).
* **Funded PhD Openings:** Actively supported by RGC GRF: Efficient Inference Serving of Foundation Models over Edge Networks (CONFIRMED_ACTIVE).
...
1. **RGC GRF: Efficient Inference Serving of Foundation Models over Edge Networks:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Pipelined Collaborative Learning across Heterogeneous Mobile Edge Devices:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Fair Scheduling of Distributed Machine Learning Jobs in Hybrid Cloud-Edge:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
| **Proposed Field: Edge Computing** | Core focus on Cloud and Edge Computing, Distributed Machine Learning Systems, Resource Scheduling | **Strong alignment** | Direct 100% domain overlap with Prof. Chuan Wu's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Chuan Wu's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Chuan Wu's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Chuan Wu's active research in real-time edge video stream analytics.
...
Prof. Chuan Wu's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Chuan Wu | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor in Department of Computer Science (CS) | Strong Alignment |
...
| **Primary Research Field** | Edge Computing | Cloud and Edge Computing, Distributed Machine Learning Systems | 100% Direct Match |
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Chuan Wu.
```
