...
**Target Professor:** Prof. Indranil Gupta  
...
Prof. Indranil Gupta is a prominent researcher in Distributed Systems at University of Illinois Urbana-Champaign (United States), directing research within the Distributed Systems Group (DPG). This assessment evaluates Prof. Indranil Gupta's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Full Graduate Research Assistantship (GRA / RA / Teaching Assistantship GTA) ($32,000 - $48,000/year living stipend paid semi-monthly + university-subsidized comprehensive health, dental, and vision insurance; Deadline: 2026-12-15), Prof. Indranil Gupta presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Indranil Gupta
* **Current Position:** Professor of Computer Science
* **University:** University of Illinois Urbana-Champaign
* **Department:** Siebel School of Computing and Data Science
* **Research Group / Lab:** Distributed Systems Group (DPG)
* **Official University Profile:** [https://cs.illinois.edu/about/people/department-faculty/indy](https://cs.illinois.edu/about/people/department-faculty/indy)
* **Personal / Academic Website:** [https://indy.cs.illinois.edu/](https://indy.cs.illinois.edu/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=Y7y8V1MAAAAJ](https://scholar.google.com/citations?user=Y7y8V1MAAAAJ)
* **ORCID:** 0000-0002-3987-6543
* **Current Research Areas:** Distributed Systems, Cloud-Edge Computing, Distributed Consensus, Fault Tolerance, Stream Processing
* **Academic Standing:** Professor of Computer Science (Tier 1 in United States Edge Computing landscape)
...
Prof. Indranil Gupta's research career spans over 1 years of systems evolution, transitioning from early foundational systems (2023–2031) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2019–2023).
...
Distributed Systems
  ...
  ├── Cloud-Edge Computing (Secondary)
...
* **Cloud-Edge Computing:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** NSF Large Distributed Systems Grants; Google and Microsoft Faculty Research Awards; Full Graduate Research Assistantship (GRA / RA / Teaching Assistantship GTA)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (UIUC DPG Cluster, Edge Chaos Engineering Testbed).
* **Funded PhD Openings:** Actively supported by NSF Large Distributed Systems Grants (CONFIRMED_ACTIVE).
...
1. **NSF Large Distributed Systems Grants:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Google and Microsoft Faculty Research Awards:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Distributed Systems Group (DPG) with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Distributed Systems Group (DPG) | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Distributed Systems, Cloud-Edge Computing, Distributed Consensus | **Strong alignment** | Direct 100% domain overlap with Prof. Indranil Gupta's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Indranil Gupta's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Indranil Gupta's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Indranil Gupta's active research in real-time edge video stream analytics.
...
Prof. Indranil Gupta's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Indranil Gupta | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Computer Science in Siebel School of Computing and Data Science | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Distributed Systems Group (DPG) | High Value Complement |
| **Primary Research Field** | Edge Computing | Distributed Systems, Cloud-Edge Computing | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Distributed Systems Group (DPG)?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Indranil Gupta.
```
...
* **University:** University of Illinois Urbana-Champaign
* **Department:** Siebel School of Computing and Data Science
* **Laboratory:** Distributed Systems Group (DPG)
...
Prof. Indranil Gupta is an active academic authority at University of Illinois Urbana-Champaign, leading research within the Distributed Systems Group (DPG). Over a prolific academic trajectory spanning from 2023 to 2023, Prof. Indranil Gupta has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Indranil Gupta is primarily a researcher in Distributed Systems, with expertise spanning Cloud-Edge Computing, Distributed Consensus, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."
...
* **[FACT]** Official Faculty Profile: https://cs.illinois.edu/about/people/department-faculty/indy
* **[FACT]** Recruitment Verification Record: 'Recruiting PhD students with strong distributed systems, algorithms, and systems programming interests.' (Source: official_lab_website, Date: 2026-01-15)
