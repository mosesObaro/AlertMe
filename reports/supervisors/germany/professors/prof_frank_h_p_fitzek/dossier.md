...
**Target Professor:** Prof. Frank H. P. Fitzek  
...
Prof. Frank H. P. Fitzek is a prominent researcher in Tactile Internet at TU Dresden (Germany), directing research within the Deutsche Telekom Chair of Communication Networks / CeTI. This assessment evaluates Prof. Frank H. P. Fitzek's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position) (€48,000 - €56,000 gross/year (100% TV-L E13 salary) or €36,000 - €42,000 (75% TV-L E13), including full health, unemployment, and statutory pension insurance; Deadline: 2026-12-01), Prof. Frank H. P. Fitzek presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Frank H. P. Fitzek
* **Current Position:** Deutsche Telekom Chair of Communication Networks
* **University:** TU Dresden
* **Department:** Faculty of Electrical and Computer Engineering
* **Research Group / Lab:** Deutsche Telekom Chair of Communication Networks / CeTI
* **Official University Profile:** [https://tu-dresden.de/ing/elektrotechnik/ifn/tkn/die-professur/inhaber](https://tu-dresden.de/ing/elektrotechnik/ifn/tkn/die-professur/inhaber)
* **Personal / Academic Website:** [https://ceti.one/](https://ceti.one/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=nZgJv54AAAAJ](https://scholar.google.com/citations?user=nZgJv54AAAAJ)
* **ORCID:** 0000-0002-3921-8971
* **Current Research Areas:** Tactile Internet, 5G/6G Networks, Network Coding for Edge Systems, Mobile Edge Cloud, Robotics Edge Control
* **Academic Standing:** Deutsche Telekom Chair of Communication Networks (Tier 1 in Germany Edge Computing landscape)
...
* **Tactile Internet:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **5G/6G Networks:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** DFG Cluster of Excellence; BMBF 6G Hub (€70M funding); TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (CeTI Tactile Internet Testbed, Dresden 5G/6G Campus Network).
* **Funded PhD Openings:** Actively supported by DFG Cluster of Excellence (CONFIRMED_ACTIVE).
...
1. **DFG Cluster of Excellence:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **BMBF 6G Hub (€70M funding):** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Deutsche Telekom Chair of Communication Networks / CeTI with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Faculty of Electrical and Computer Engineering | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Deutsche Telekom Chair of Communication Networks / CeTI | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Tactile Internet, 5G/6G Networks, Network Coding for Edge Systems | **Strong alignment** | Direct 100% domain overlap with Prof. Frank H. P. Fitzek's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Frank H. P. Fitzek's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Frank H. P. Fitzek's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Frank H. P. Fitzek's active research in real-time edge video stream analytics.
...
Prof. Frank H. P. Fitzek's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Frank H. P. Fitzek | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Deutsche Telekom Chair of Communication Networks in Faculty of Electrical and Computer Engineering | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Deutsche Telekom Chair of Communication Networks / CeTI | High Value Complement |
| **Primary Research Field** | Edge Computing | Tactile Internet, 5G/6G Networks | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Deutsche Telekom Chair of Communication Networks / CeTI?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Frank H. P. Fitzek.
```
...
* **University:** TU Dresden
* **Department:** Faculty of Electrical and Computer Engineering
* **Laboratory:** Deutsche Telekom Chair of Communication Networks / CeTI
* **Associated Research Centers:** Centre for Tactile Internet with Human-in-the-Loop (CeTI), Barkhausen Institut, ScaDS.AI
* **Hardware & Systems Testbeds:** CeTI Tactile Internet Testbed, Dresden 5G/6G Campus Network
...
* **BMBF 6G Hub (€70M funding):** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Dependants (spouse and minor children) are eligible for fami | Deadline: Aligned with faculty recruitment cycle
