...
**Target Professor:** Prof. Michael Gerndt  
...
Prof. Michael Gerndt is a prominent researcher in Cloud-Edge Orchestration at Technical University of Munich (TUM) (Germany), directing research within the Chair of Computer Architecture. This assessment evaluates Prof. Michael Gerndt's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position) (€48,000 - €56,000 gross/year (100% TV-L E13 salary) or €36,000 - €42,000 (75% TV-L E13), including full health, unemployment, and statutory pension insurance; Deadline: 2026-12-01), Prof. Michael Gerndt presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Michael Gerndt
* **Current Position:** Professor of Computer Architecture
* **University:** Technical University of Munich (TUM)
* **Department:** TUM School of Computation, Information and Technology (CIT)
* **Research Group / Lab:** Chair of Computer Architecture
* **Official University Profile:** [https://www.caps.in.tum.de/en/team/gerndt/](https://www.caps.in.tum.de/en/team/gerndt/)
* **Personal / Academic Website:** [https://www.caps.in.tum.de/](https://www.caps.in.tum.de/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=Y94y_pIAAAAJ](https://scholar.google.com/citations?user=Y94y_pIAAAAJ)
* **ORCID:** 0000-0002-7643-9821
* **Current Research Areas:** Cloud-Edge Orchestration, Autonomous Performance Tuning, Serverless Systems, High Performance Computing, Edge AI Accelerators
* **Academic Standing:** Professor of Computer Architecture (Tier 1 in Germany Edge Computing landscape)
...
Cloud-Edge Orchestration
  ├── Cloud-Edge Orchestration (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Autonomous Performance Tuning (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── Edge AI Accelerators (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **Cloud-Edge Orchestration:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Autonomous Performance Tuning:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **Edge AI Accelerators:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
* **Active Projects & Grants:** EU Horizon Europe Grants; DFG Collaborative Research Centres; TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (TUM CAPS Edge-Cloud Cluster).
* **Funded PhD Openings:** Actively supported by EU Horizon Europe Grants (CONFIRMED_ACTIVE).
...
1. **EU Horizon Europe Grants:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **DFG Collaborative Research Centres:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Chair of Computer Architecture with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Chair of Computer Architecture | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Cloud-Edge Orchestration, Autonomous Performance Tuning, Serverless Systems | **Strong alignment** | Direct 100% domain overlap with Prof. Michael Gerndt's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Michael Gerndt's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Michael Gerndt's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Michael Gerndt's active research in real-time edge video stream analytics.
...
Prof. Michael Gerndt's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Michael Gerndt | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Computer Architecture in TUM School of Computation, Information and Technology (CIT) | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Chair of Computer Architecture | High Value Complement |
| **Primary Research Field** | Edge Computing | Cloud-Edge Orchestration, Autonomous Performance Tuning | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Chair of Computer Architecture?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Michael Gerndt.
```
...
* **University:** Technical University of Munich (TUM)
* **Department:** TUM School of Computation, Information and Technology (CIT)
* **Laboratory:** Chair of Computer Architecture
...
* **Hardware & Systems Testbeds:** TUM CAPS Edge-Cloud Cluster
