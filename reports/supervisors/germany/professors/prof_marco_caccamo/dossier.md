...
**Target Professor:** Prof. Marco Caccamo  
...
Prof. Marco Caccamo is a prominent researcher in Safety-Critical Edge Systems at Technical University of Munich (TUM) (Germany), directing research within the Chair of Cyber-Physical Systems. This assessment evaluates Prof. Marco Caccamo's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position) (€48,000 - €56,000 gross/year (100% TV-L E13 salary) or €36,000 - €42,000 (75% TV-L E13), including full health, unemployment, and statutory pension insurance; Deadline: 2026-12-01), Prof. Marco Caccamo presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Marco Caccamo
* **Current Position:** Alexander von Humboldt Professor & Chair of Cyber-Physical Systems in Production Engineering
* **University:** Technical University of Munich (TUM)
* **Department:** TUM School of Engineering and Design
* **Research Group / Lab:** Chair of Cyber-Physical Systems
* **Official University Profile:** [https://www.mec.ed.tum.de/en/cps/people/prof-dr-marco-caccamo/](https://www.mec.ed.tum.de/en/cps/people/prof-dr-marco-caccamo/)
* **Personal / Academic Website:** [https://www.cps.ed.tum.de/](https://www.cps.ed.tum.de/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=a0lK-kAAAAAJ](https://scholar.google.com/citations?user=a0lK-kAAAAAJ)
* **ORCID:** 0000-0002-3921-1234
* **Current Research Areas:** Safety-Critical Edge Systems, Real-Time Computing, Cyber-Physical Systems, Multi-Core Predictability, Embedded Edge AI
* **Academic Standing:** Alexander von Humboldt Professor & Chair of Cyber-Physical Systems in Production Engineering (Tier 1 in Germany Edge Computing landscape)
...
Prof. Marco Caccamo's research career spans over 1 years of systems evolution, transitioning from early foundational systems (2023–2031) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2019–2023).
...
```text
Safety-Critical Edge Systems
  ├── Safety-Critical Edge Systems (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Real-Time Computing (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── Embedded Edge AI (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **Safety-Critical Edge Systems:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Real-Time Computing:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **Embedded Edge AI:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
### 1. Predictable and Safe Execution of Deep Neural Networks on Embedded Edge Platforms
* **Year:** 2023
* **Venue:** IEEE Real-Time Systems Symposium (RTSS)
* **DOI / Link:** [https://doi.org/10.1109/RTSS58432.2023.00021](https://doi.org/10.1109/RTSS58432.2023.00021)
* **Problem Addressed:** Black-box neural execution engines violate real-time worst-case execution time (WCET) guarantees.
* **Approach:** Deterministic scratchpad partition scheduling with hardware memory throttling.
* **Key Contribution:** Provides first formally certified real-time bounding framework for edge vision models.
...
* **Active Projects & Grants:** Alexander von Humboldt Foundation Professorship (€5M); DFG Research Grants; TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (TUM Autonomous Driving Scale-Car Bed, Predictable Multi-Core Testbed).
* **Funded PhD Openings:** Actively supported by Alexander von Humboldt Foundation Professorship (€5M) (CONFIRMED_ACTIVE).
...
* **Institutional Collaborators:** M. Caccamo, R. Mancuso
...
1. **Alexander von Humboldt Foundation Professorship (€5M):** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **DFG Research Grants:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position):** Provider: German Federal States Public Tariff (Tarifvertrag für den öffentlichen Dienst der Länder) (FULLY_FUNDED). Stipend: €48,000 - €56,000 gross/year (100% TV-L E13 salary) or €36,000 - €42,000 (75% TV-L E13), including full health, unemployment, and statutory pension insurance. Deadline: 2026-12-01.
4. **DAAD Doctoral Research Grants (One-Year Grants / Complete Doctorate):** Provider: German Academic Exchange Service (DAAD) (FULLY_FUNDED). Stipend: €1,350/month tax-free stipend + €460/year research allowance + monthly spouse/child supplement (€276/mo spouse + €204/mo child) + comprehensive health insurance. Deadline: 2026-11-01.
5. **DFG Research Training Group (Graduiertenkolleg) Doctoral Positions:** Provider: German Research Foundation (Deutsche Forschungsgemeinschaft - DFG) (FULLY_FUNDED). Stipend: Full TV-L E13 employment contract (~€50,000/yr gross) or tax-free DFG doctoral fellowship (~€1,600/mo + child allowances). Deadline: 2026-12-15.

---

## 15. PhD Supervision Analysis

* **Research Group Culture:** Collaborative, lab-based culture in Chair of Cyber-Physical Systems with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in TUM School of Engineering and Design | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Chair of Cyber-Physical Systems | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Safety-Critical Edge Systems, Real-Time Computing, Cyber-Physical Systems | **Strong alignment** | Direct 100% domain overlap with Prof. Marco Caccamo's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Marco Caccamo's pioneering work in split computing and early-exit networks (Predictable and Safe Execution of Deep Neural Networks on Embedded Edge Platforms).
...
* **Professor's Expertise:** Prof. Marco Caccamo's research in decentralized edge computing architectures (Predictable and Safe Execution of Deep Neural Networks on Embedded Edge Platforms).
...
* **Professor's Expertise:** Prof. Marco Caccamo's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Marco Caccamo's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Marco Caccamo's active research in real-time edge video stream analytics.
...
Prof. Marco Caccamo's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Marco Caccamo | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Alexander von Humboldt Professor & Chair of Cyber-Physical Systems in Production Engineering in TUM School of Engineering and Design | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Chair of Cyber-Physical Systems | High Value Complement |
| **Primary Research Field** | Edge Computing | Safety-Critical Edge Systems, Real-Time Computing | 100% Direct Match |
| **AI / ML Focus** | Edge AI / TinyML / Distributed ML | Split DNN Inference, Model Compression, Edge Intelligence | Strong Alignment |
| **Target Funding Scheme** | Competitive Doctoral Scholarship / Studentship | Eligible for TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position) | Prime Synergy |
...
| :--- | :---: | :--- |
| Research-Topic Alignment | 8.9 | Score: 8.9/10 based on verified disclosures and publication record |
...
STRONGLY RECOMMEND APPROACHING (Tier 1 Priority). Exceptional research fit (89.5%), verified recruitment standing (CONFIRMED_ACTIVE), and immediate proposal synergy with your Computer Engineering and software systems background.
...
1. In your recent work on 'Predictable and Safe Execution of Deep Neural Networks on Embedded Edge Platforms', what is the primary systems bottleneck when scaling across heterogeneous devices with different neural hardware accelerators?
...
3. How are doctoral research topics typically structured in Chair of Cyber-Physical Systems—do incoming PhD students formulate their own proposals or integrate into specific funded grant milestones?
...
5. What criteria and milestones do you prioritize when nominating prospective doctoral applicants for the TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position)?
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Chair of Cyber-Physical Systems?
...
### Tier 1 — Must Read
1. *Predictable and Safe Execution of Deep Neural Networks on Embedded Edge Platforms* (IEEE Real-Time Systems Symposium (RTSS), 2023)

### Tier 2 — Research Evolution
2. *Predictable and Safe Execution of Deep Neural Networks on Embedded Edge Platforms* (IEEE Real-Time Systems Symposium (RTSS), 2023)

### Tier 3 — PhD Alignment
3. *Predictable and Safe Execution of Deep Neural Networks on Embedded Edge Platforms* (IEEE Real-Time Systems Symposium (RTSS), 2023)
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Marco Caccamo.
```
...
* **University:** Technical University of Munich (TUM)
* **Department:** TUM School of Engineering and Design
* **Laboratory:** Chair of Cyber-Physical Systems
* **Associated Research Centers:** Munich Data Science Institute (MDSI), Munich Center for Machine Learning (MCML), Munich Institute of Robotics and Machine Intelligence (MIRMI)
* **Hardware & Systems Testbeds:** TUM Autonomous Driving Scale-Car Bed, Predictable Multi-Core Testbed
* **Graduate School:** [https://www.gs.tum.de/en/gs/home/](https://www.gs.tum.de/en/gs/home/)

---

## 29. Funding Opportunities, Pathways & Eligibility
* **Alexander von Humboldt Foundation Professorship (€5M):** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Dependants (spouse and minor children) are eligible for fami | Deadline: Aligned with faculty recruitment cycle
* **DFG Research Grants:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Dependants (spouse and minor children) are eligible for fami | Deadline: Aligned with faculty recruitment cycle
* **TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position):** Provider: German Federal States Public Tariff (Tarifvertrag für den öffentlichen Dienst der Länder) | Type: FULLY_FUNDED | Stipend: €48,000 - €56,000 gross/year (100% TV-L E13 salary) or €36,000 - €42,000 (75% TV-L E13), including full health, unemployment, and statutory pension insurance | Tuition: Full tuition-free education (German public universities charge zero tuition; only nominal semester fee ~€150-€350 including transit pass) | Duration: 3 to 5 years (standard employment contract) | International Eligibility: ELIGIBLE | Dependant Support: EXCELLENT | Deadline: 2026-12-01
* **DAAD Doctoral Research Grants (One-Year Grants / Complete Doctorate):** Provider: German Academic Exchange Service (DAAD) | Type: FULLY_FUNDED | Stipend: €1,350/month tax-free stipend + €460/year research allowance + monthly spouse/child supplement (€276/mo spouse + €204/mo child) + comprehensive health insurance | Tuition: Zero tuition at German universities; DAAD covers all mandatory semester contributions | Duration: Up to 3 to 4 years | International Eligibility: ELIGIBLE | Dependant Support: EXCELLENT | Deadline: 2026-11-01
* **DFG Research Training Group (Graduiertenkolleg) Doctoral Positions:** Provider: German Research Foundation (Deutsche Forschungsgemeinschaft - DFG) | Type: FULLY_FUNDED | Stipend: Full TV-L E13 employment contract (~€50,000/yr gross) or tax-free DFG doctoral fellowship (~€1,600/mo + child allowances) | Tuition: Zero tuition + travel grants + workshop subsidies | Duration: 3 to 4 years | International Eligibility: ELIGIBLE | Dependant Support: EXCELLENT | Deadline: 2026-12-15
...
Prof. Marco Caccamo is an active academic authority at Technical University of Munich (TUM), leading research within the Chair of Cyber-Physical Systems. Over a prolific academic trajectory spanning from 2023 to 2023, Prof. Marco Caccamo has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Marco Caccamo is primarily a researcher in Safety-Critical Edge Systems, with expertise spanning Real-Time Computing, Cyber-Physical Systems, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."

---

## 31. Final Supervisor Recommendation

### Recommendation: STRONGLY RECOMMEND APPROACHING (Tier 1 Priority). Exceptional research fit (89.5%), verified recruitment standing (CONFIRMED_ACTIVE), and immediate proposal synergy with your Computer Engineering and software systems background.

---

## 32. Sources & Evidence Requirements
* **[FACT]** Official Faculty Profile: https://www.mec.ed.tum.de/en/cps/people/prof-dr-marco-caccamo/
* **[FACT]** Recruitment Verification Record: 'Recruiting doctoral candidates (TV-L E13 100%) in real-time systems, embedded software, and safety-critical edge architectures.' (Source: official_lab_website, Date: 2026-01-20)
