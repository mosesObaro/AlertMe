...
**Target Professor:** Prof. David Bermbach  
...
Prof. David Bermbach is a prominent researcher in Edge Computing at Technical University of Berlin (TU Berlin) (Germany), directing research within the Mobile Cloud Computing (MCC) Group. This assessment evaluates Prof. David Bermbach's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position) (€48,000 - €56,000 gross/year (100% TV-L E13 salary) or €36,000 - €42,000 (75% TV-L E13), including full health, unemployment, and statutory pension insurance; Deadline: 2026-12-01), Prof. David Bermbach presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. David Bermbach
* **Current Position:** Professor & Head of Mobile Cloud Computing Group
* **University:** Technical University of Berlin (TU Berlin)
* **Department:** Faculty of Electrical Engineering and Computer Science
* **Research Group / Lab:** Mobile Cloud Computing (MCC) Group
* **Official University Profile:** [https://www.mcc.tu-berlin.de/menue/team/david_bermbach/](https://www.mcc.tu-berlin.de/menue/team/david_bermbach/)
* **Personal / Academic Website:** [https://www.mcc.tu-berlin.de/](https://www.mcc.tu-berlin.de/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=LdE2WzEAAAAJ](https://scholar.google.com/citations?user=LdE2WzEAAAAJ)
* **ORCID:** 0000-0002-3081-305X
* **Current Research Areas:** Edge Computing, Serverless Edge, Fog Robotics, Edge Benchmarking, Cloud-Edge Continuum, Distributed Systems Benchmarking
* **Academic Standing:** Professor & Head of Mobile Cloud Computing Group (Tier 1 in Germany Edge Computing landscape)
...
Prof. David Bermbach's research career spans over 1 years of systems evolution, transitioning from early foundational systems (2024–2032) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2020–2024).
...
* **Serverless Edge:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** DFG Emmy Noether / Heisenberg Fellowship; EU Horizon Edge Initiatives; TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (TU Berlin Fog Testbed, Distributed Robotics Edge Bed).
* **Funded PhD Openings:** Actively supported by DFG Emmy Noether / Heisenberg Fellowship (CONFIRMED_ACTIVE).
...
1. **DFG Emmy Noether / Heisenberg Fellowship:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **EU Horizon Edge Initiatives:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Mobile Cloud Computing (MCC) Group with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Faculty of Electrical Engineering and Computer Science | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Mobile Cloud Computing (MCC) Group | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Edge Computing, Serverless Edge, Fog Robotics | **Strong alignment** | Direct 100% domain overlap with Prof. David Bermbach's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. David Bermbach's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. David Bermbach's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. David Bermbach's active research in real-time edge video stream analytics.
...
Prof. David Bermbach's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. David Bermbach | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor & Head of Mobile Cloud Computing Group in Faculty of Electrical Engineering and Computer Science | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Mobile Cloud Computing (MCC) Group | High Value Complement |
| **Primary Research Field** | Edge Computing | Edge Computing, Serverless Edge | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Mobile Cloud Computing (MCC) Group?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. David Bermbach.
```
...
* **University:** Technical University of Berlin (TU Berlin)
* **Department:** Faculty of Electrical Engineering and Computer Science
* **Laboratory:** Mobile Cloud Computing (MCC) Group
* **Associated Research Centers:** Berlin Institute for the Foundations of Learning and Data (BIFOLD), Einstein Center Digital Future
* **Hardware & Systems Testbeds:** TU Berlin Fog Testbed, Distributed Robotics Edge Bed
* **Graduate School:** [https://www.tu.berlin/en/go1625/](https://www.tu.berlin/en/go1625/)

---

## 29. Funding Opportunities, Pathways & Eligibility
* **DFG Emmy Noether / Heisenberg Fellowship:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Dependants (spouse and minor children) are eligible for fami | Deadline: Aligned with faculty recruitment cycle
* **EU Horizon Edge Initiatives:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Dependants (spouse and minor children) are eligible for fami | Deadline: Aligned with faculty recruitment cycle
...
Prof. David Bermbach is an active academic authority at Technical University of Berlin (TU Berlin), leading research within the Mobile Cloud Computing (MCC) Group. Over a prolific academic trajectory spanning from 2024 to 2024, Prof. David Bermbach has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. David Bermbach is primarily a researcher in Edge Computing, with expertise spanning Serverless Edge, Fog Robotics, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."
...
* **[FACT]** Official Faculty Profile: https://www.mcc.tu-berlin.de/menue/team/david_bermbach/
