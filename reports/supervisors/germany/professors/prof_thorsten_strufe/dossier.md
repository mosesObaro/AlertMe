...
**Target Professor:** Prof. Thorsten Strufe  
...
Prof. Thorsten Strufe is a prominent researcher in Decentralized Edge Systems at Karlsruhe Institute of Technology (KIT) / TU Dresden (Germany), directing research within the Practical Cybersecurity and Decentralized Systems. This assessment evaluates Prof. Thorsten Strufe's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position) (€48,000 - €56,000 gross/year (100% TV-L E13 salary) or €36,000 - €42,000 (75% TV-L E13), including full health, unemployment, and statutory pension insurance; Deadline: 2026-12-01), Prof. Thorsten Strufe presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Thorsten Strufe
* **Current Position:** Professor of Practical Computer Science & Security
* **University:** Karlsruhe Institute of Technology (KIT) / TU Dresden
* **Department:** KIT Department of Informatics
* **Research Group / Lab:** Practical Cybersecurity and Decentralized Systems
* **Official University Profile:** [https://ps.inf.kit.edu/people/strufe/](https://ps.inf.kit.edu/people/strufe/)
* **Personal / Academic Website:** [https://ps.inf.kit.edu/](https://ps.inf.kit.edu/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=2o1G8mIAAAAJ](https://scholar.google.com/citations?user=2o1G8mIAAAAJ)
* **ORCID:** 0000-0003-3456-9876
* **Current Research Areas:** Decentralized Edge Systems, Privacy-Enhancing Technologies, Network Anonymity, Federated Learning Privacy, Edge Threat Modeling
* **Academic Standing:** Professor of Practical Computer Science & Security (Tier 1 in Germany Edge Computing landscape)
...
```text
Decentralized Edge Systems
  ├── Decentralized Edge Systems (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Privacy-Enhancing Technologies (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── Federated Learning Privacy (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **Decentralized Edge Systems:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Privacy-Enhancing Technologies:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **Federated Learning Privacy:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
* **Active Projects & Grants:** BMBF Cybersecurity Competence Center; DFG Priority Programme; TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (KASTEL Security Testbed, Decentralized P2P Edge Bed).
* **Funded PhD Openings:** Actively supported by BMBF Cybersecurity Competence Center (CONFIRMED_ACTIVE).
...
1. **BMBF Cybersecurity Competence Center:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Practical Cybersecurity and Decentralized Systems with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in KIT Department of Informatics | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Practical Cybersecurity and Decentralized Systems | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Decentralized Edge Systems, Privacy-Enhancing Technologies, Network Anonymity | **Strong alignment** | Direct 100% domain overlap with Prof. Thorsten Strufe's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Thorsten Strufe's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Thorsten Strufe's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Thorsten Strufe's active research in real-time edge video stream analytics.
...
Prof. Thorsten Strufe's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Thorsten Strufe | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Practical Computer Science & Security in KIT Department of Informatics | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Practical Cybersecurity and Decentralized Systems | High Value Complement |
| **Primary Research Field** | Edge Computing | Decentralized Edge Systems, Privacy-Enhancing Technologies | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Practical Cybersecurity and Decentralized Systems?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Thorsten Strufe.
```
