...
**Target Professor:** Prof. Klaus Wehrle  
...
Prof. Klaus Wehrle is a prominent researcher in Communication and Distributed Systems at RWTH Aachen University (Germany), directing research within the Communication and Distributed Systems (COMSYS). This assessment evaluates Prof. Klaus Wehrle's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position) (€48,000 - €56,000 gross/year (100% TV-L E13 salary) or €36,000 - €42,000 (75% TV-L E13), including full health, unemployment, and statutory pension insurance; Deadline: 2026-12-01), Prof. Klaus Wehrle presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Klaus Wehrle
* **Current Position:** Chair Professor of Communication and Distributed Systems
* **University:** RWTH Aachen University
* **Department:** Department of Computer Science
* **Research Group / Lab:** Communication and Distributed Systems (COMSYS)
* **Official University Profile:** [https://www.comsys.rwth-aachen.de/team/klaus-wehrle/](https://www.comsys.rwth-aachen.de/team/klaus-wehrle/)
* **Personal / Academic Website:** [https://www.comsys.rwth-aachen.de/](https://www.comsys.rwth-aachen.de/)
...
* **ORCID:** 0000-0001-9252-4188
* **Current Research Areas:** Communication and Distributed Systems, In-Network Computing, Network Programmability (P4), Edge Network Virtualization, Industrial IoT
* **Academic Standing:** Chair Professor of Communication and Distributed Systems (Tier 1 in Germany Edge Computing landscape)
...
Communication and Distributed Systems
  ├── Communication and Distributed Systems (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── In-Network Computing (Secondary)
...
* **Communication and Distributed Systems:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **In-Network Computing:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** DFG SFB Research Grant; EU Horizon Edge Initiatives; TV-L E13 Research Associate (Wissenschaftlicher Mitarbeiter / Doctoral Position)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (RWTH COMSYS P4 Hardware Edge Testbed, Industrial IoT Living Lab).
* **Funded PhD Openings:** Actively supported by DFG SFB Research Grant (CONFIRMED_ACTIVE).
...
1. **DFG SFB Research Grant:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Communication and Distributed Systems (COMSYS) with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Communication and Distributed Systems (COMSYS) | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Communication and Distributed Systems, In-Network Computing, Network Programmability (P4) | **Strong alignment** | Direct 100% domain overlap with Prof. Klaus Wehrle's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Klaus Wehrle's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Klaus Wehrle's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Klaus Wehrle's active research in real-time edge video stream analytics.
...
Prof. Klaus Wehrle's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Klaus Wehrle | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Chair Professor of Communication and Distributed Systems in Department of Computer Science | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Communication and Distributed Systems (COMSYS) | High Value Complement |
| **Primary Research Field** | Edge Computing | Communication and Distributed Systems, In-Network Computing | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Communication and Distributed Systems (COMSYS)?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Klaus Wehrle.
```
