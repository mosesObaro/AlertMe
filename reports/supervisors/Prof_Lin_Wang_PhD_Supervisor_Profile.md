...
**Target Professor:** Prof. Lin Wang  
...
Prof. Lin Wang is a prominent researcher in Edge Computing Systems at The Hong Kong University of Science and Technology (Hong Kong), directing research within the Edge Computing Systems Laboratory. This assessment evaluates Prof. Lin Wang's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with HKUST RedBird PhD Award & Postgraduate Studentship (PGS) (HK$40,000 recruitment award + full annual PGS of HK$220,680 (approx HK$18,390/mo); Deadline: 2026-12-01 23:59:59 HKT), Prof. Lin Wang presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Lin Wang
* **Current Position:** Associate Professor
* **University:** The Hong Kong University of Science and Technology
* **Department:** Department of Computer Science and Engineering (CSE)
* **Research Group / Lab:** Edge Computing Systems Laboratory
* **Official University Profile:** [https://cse.hkust.edu.hk/admin/people/faculty/profile/linwang](https://cse.hkust.edu.hk/admin/people/faculty/profile/linwang)
* **Personal / Academic Website:** [https://linwang.info/](https://linwang.info/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=U1k7T24AAAAJ](https://scholar.google.com/citations?user=U1k7T24AAAAJ)
* **ORCID:** 0000-0002-3904-8094
* **Current Research Areas:** Edge Computing Systems, Serverless Edge Computing, Cloud-Edge Resource Allocation, Microservice Systems, Network Function Virtualization
...
Edge Computing Systems
  ├── Edge Computing Systems (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Serverless Edge Computing (Secondary)
...
* **Edge Computing Systems:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Serverless Edge Computing:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** WebAssembly Runtimes for Latency-Critical Edge Serverless; Predictive Pre-warming of Edge Containers using Temporal Machine Learning; Decentralized Resource Scheduling for Multi-Tenant Edge Clusters
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (K3s / OpenFaaS Edge Testbed, Firecracker MicroVM Cluster, WasmEdge Runtimes).
* **Funded PhD Openings:** Actively supported by WebAssembly Runtimes for Latency-Critical Edge Serverless (CONFIRMED_ACTIVE).
...
1. **WebAssembly Runtimes for Latency-Critical Edge Serverless:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Predictive Pre-warming of Edge Containers using Temporal Machine Learning:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Decentralized Resource Scheduling for Multi-Tenant Edge Clusters:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
4. **HKUST RedBird PhD Award & Postgraduate Studentship (PGS):** Provider: Hong Kong Research Grants Council (SCHOLARSHIP). Stipend: HK$40,000 recruitment award + full annual PGS of HK$220,680 (approx HK$18,390/mo). Deadline: 2026-12-01 23:59:59 HKT.

---

## 15. PhD Supervision Analysis

* **Research Group Culture:** Collaborative, lab-based culture in Edge Computing Systems Laboratory with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Edge Computing Systems Laboratory | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Edge Computing Systems, Serverless Edge Computing, Cloud-Edge Resource Allocation | **Strong alignment** | Direct 100% domain overlap with Prof. Lin Wang's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Lin Wang's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Lin Wang's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Lin Wang's active research in real-time edge video stream analytics.
...
Prof. Lin Wang's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Lin Wang | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Associate Professor in Department of Computer Science and Engineering (CSE) | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Edge Computing Systems Laboratory | High Value Complement |
| **Primary Research Field** | Edge Computing | Edge Computing Systems, Serverless Edge Computing | 100% Direct Match |
| **AI / ML Focus** | Edge AI / TinyML / Distributed ML | Split DNN Inference, Model Compression, Edge Intelligence | Strong Alignment |
| **Target Funding Scheme** | Competitive Doctoral Scholarship / Studentship | Eligible for HKUST RedBird PhD Award & Postgraduate Studentship (PGS) | Prime Synergy |
...
5. What criteria and milestones do you prioritize when nominating prospective doctoral applicants for the HKUST RedBird PhD Award & Postgraduate Studentship (PGS)?
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Edge Computing Systems Laboratory?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Lin Wang.
```
...
* **Hardware & Systems Testbeds:** K3s / OpenFaaS Edge Testbed, Firecracker MicroVM Cluster, WasmEdge Runtimes
* **Graduate School:** [https://cse.hkust.edu.hk/admin/people/faculty/profile/linwang](https://cse.hkust.edu.hk/admin/people/faculty/profile/linwang)

---

## 29. Funding Opportunities, Pathways & Eligibility
* **WebAssembly Runtimes for Latency-Critical Edge Serverless:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Permitted under national immigration guidelines | Deadline: Aligned with faculty recruitment cycle
* **Predictive Pre-warming of Edge Containers using Temporal Machine Learning:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Permitted under national immigration guidelines | Deadline: Aligned with faculty recruitment cycle
* **Decentralized Resource Scheduling for Multi-Tenant Edge Clusters:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Permitted under national immigration guidelines | Deadline: Aligned with faculty recruitment cycle
* **HKUST RedBird PhD Award & Postgraduate Studentship (PGS):** Provider: Hong Kong Research Grants Council | Type: SCHOLARSHIP | Stipend: HK$40,000 recruitment award + full annual PGS of HK$220,680 (approx HK$18,390/mo) | Tuition: Tuition scholarship available for HKPFS recipients (HK$42,100/yr) | Duration: 4 years (standard 4-year PhD) | International Eligibility: ELIGIBLE | Dependant Support: None officially provided for dependents | Deadline: 2026-12-01 23:59:59 HKT
