...
**Target Professor:** Prof. Hiroshi Esaki  
...
Prof. Hiroshi Esaki is a prominent researcher in Smart Building Edge Computing at The University of Tokyo (Japan), directing research within the Esaki Laboratory / WIDE Project. This assessment evaluates Prof. Hiroshi Esaki's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with The University of Tokyo Special Scholarship for International Students (UTokyo Fellowship) (150,000 - 200,000 JPY/month research grant stipend; Deadline: 2026-11-15), Prof. Hiroshi Esaki presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Hiroshi Esaki
* **Current Position:** Professor & Director of WIDE Project
* **University:** The University of Tokyo
* **Department:** Graduate School of Information Science and Technology
* **Research Group / Lab:** Esaki Laboratory / WIDE Project
* **Official University Profile:** [https://www.hongo.wide.ad.jp/](https://www.hongo.wide.ad.jp/)
* **Personal / Academic Website:** [https://www.wide.ad.jp/](https://www.wide.ad.jp/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=517b6-cAAAAJ](https://scholar.google.com/citations?user=517b6-cAAAAJ)
* **ORCID:** 0000-0002-1245-7789
* **Current Research Areas:** Smart Building Edge Computing, Internet of Things, IPv6 Architecture, Energy-Efficient Edge Systems, Digital Twin Networks
* **Academic Standing:** Professor & Director of WIDE Project (Tier 1 in Japan Edge Computing landscape)
...
Smart Building Edge Computing
  ├── Smart Building Edge Computing (Primary)
...
* **Smart Building Edge Computing:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
...
* **Active Projects & Grants:** JST CREST Smart Infrastructure; MEXT KAKENHI Grants; The University of Tokyo Special Scholarship for International Students (UTokyo Fellowship)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (UTokyo Smart Campus Testbed, WIDE IPv6 Living Lab).
* **Funded PhD Openings:** Actively supported by JST CREST Smart Infrastructure (CONFIRMED_ACTIVE).
...
1. **JST CREST Smart Infrastructure:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Esaki Laboratory / WIDE Project with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Esaki Laboratory / WIDE Project | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Smart Building Edge Computing, Internet of Things, IPv6 Architecture | **Strong alignment** | Direct 100% domain overlap with Prof. Hiroshi Esaki's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Hiroshi Esaki's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Hiroshi Esaki's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Hiroshi Esaki's active research in real-time edge video stream analytics.
...
Prof. Hiroshi Esaki's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Hiroshi Esaki | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor & Director of WIDE Project in Graduate School of Information Science and Technology | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Esaki Laboratory / WIDE Project | High Value Complement |
| **Primary Research Field** | Edge Computing | Smart Building Edge Computing, Internet of Things | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Esaki Laboratory / WIDE Project?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Hiroshi Esaki.
```
...
* **University:** The University of Tokyo
* **Department:** Graduate School of Information Science and Technology
* **Laboratory:** Esaki Laboratory / WIDE Project
...
* **Hardware & Systems Testbeds:** UTokyo Smart Campus Testbed, WIDE IPv6 Living Lab
