...
**Target Professor:** Prof. Masaki Aida  
...
Prof. Masaki Aida is a prominent researcher in Autonomous Decentralized Systems at Tokyo Metropolitan University / Keio University (Japan), directing research within the Information Network Systems Laboratory. This assessment evaluates Prof. Masaki Aida's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (STRONG_EVIDENCE) and direct synergy with Japanese Government (MEXT) Doctoral Scholarship (University & Embassy Track) (145,000 - 148,000 JPY/month tax-free living allowance + roundtrip international airfare; Deadline: 2026-11-30), Prof. Masaki Aida presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Masaki Aida
* **Current Position:** Professor
* **University:** Tokyo Metropolitan University / Keio University
* **Department:** Department of Computer Science
* **Research Group / Lab:** Information Network Systems Laboratory
* **Official University Profile:** [https://www.comp.tmu.ac.jp/aida-lab/index-e.html](https://www.comp.tmu.ac.jp/aida-lab/index-e.html)
* **Personal / Academic Website:** [https://www.comp.tmu.ac.jp/aida-lab/](https://www.comp.tmu.ac.jp/aida-lab/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=5P5-98kAAAAJ](https://scholar.google.com/citations?user=5P5-98kAAAAJ)
* **ORCID:** 0000-0002-9876-5432
* **Current Research Areas:** Autonomous Decentralized Systems, Complex Networks, Edge Resource Allocation, Self-Organizing Networks, Queueing Theory
* **Academic Standing:** Professor (Tier 2 in Japan Edge Computing landscape)
...
Prof. Masaki Aida's research career spans over 1 years of systems evolution, transitioning from early foundational systems (2023–2031) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2019–2023).
...
Autonomous Decentralized Systems
  ├── Autonomous Decentralized Systems (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Complex Networks (Secondary)
...
* **Autonomous Decentralized Systems:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Complex Networks:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** JSPS KAKENHI Scientific Research Grant; Japanese Government (MEXT) Doctoral Scholarship (University & Embassy Track); JSPS Research Fellowship for Young Scientists (DC1 / DC2)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Autonomous Network Simulation Cluster).
* **Funded PhD Openings:** Actively supported by JSPS KAKENHI Scientific Research Grant (STRONG_EVIDENCE).
...
1. **JSPS KAKENHI Scientific Research Grant:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Japanese Government (MEXT) Doctoral Scholarship (University & Embassy Track):** Provider: Ministry of Education, Culture, Sports, Science and Technology (MEXT), Japan (FULLY_FUNDED). Stipend: 145,000 - 148,000 JPY/month tax-free living allowance + roundtrip international airfare. Deadline: 2026-11-30.
3. **JSPS Research Fellowship for Young Scientists (DC1 / DC2):** Provider: Japan Society for the Promotion of Science (JSPS) (FULLY_FUNDED). Stipend: 200,000 JPY/month monthly research stipend + up to 1,500,000 JPY/year Grants-in-Aid for Scientific Research (KAKENHI). Deadline: 2026-05-15.
4. **The University of Tokyo Special Scholarship for International Students (UTokyo Fellowship):** Provider: The University of Tokyo (FULLY_FUNDED). Stipend: 150,000 - 200,000 JPY/month research grant stipend. Deadline: 2026-11-15.

---

## 15. PhD Supervision Analysis

* **Research Group Culture:** Collaborative, lab-based culture in Information Network Systems Laboratory with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Department of Computer Science | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Information Network Systems Laboratory | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Autonomous Decentralized Systems, Complex Networks, Edge Resource Allocation | **Strong alignment** | Direct 100% domain overlap with Prof. Masaki Aida's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Masaki Aida's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Masaki Aida's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Masaki Aida's active research in real-time edge video stream analytics.
...
Prof. Masaki Aida's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Masaki Aida | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor in Department of Computer Science | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Information Network Systems Laboratory | High Value Complement |
| **Primary Research Field** | Edge Computing | Autonomous Decentralized Systems, Complex Networks | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Information Network Systems Laboratory?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Masaki Aida.
```
...
Prof. Masaki Aida is an active academic authority at Tokyo Metropolitan University / Keio University, leading research within the Information Network Systems Laboratory. Over a prolific academic trajectory spanning from 2023 to 2023, Prof. Masaki Aida has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Masaki Aida is primarily a researcher in Autonomous Decentralized Systems, with expertise spanning Complex Networks, Edge Resource Allocation, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."
...
* **[FACT]** Official Faculty Profile: https://www.comp.tmu.ac.jp/aida-lab/index-e.html
* **[FACT]** Recruitment Verification Record: 'Accepting doctoral students with strong mathematical and network systems backgrounds.' (Source: faculty_homepage, Date: 2026-01-10)
