...
**Target Professor:** Prof. Koji Yatani  
...
Prof. Koji Yatani is a prominent researcher in Mobile Edge Intelligence at The University of Tokyo (Japan), directing research within the Interactive Intelligent Systems Laboratory (IIS Lab). This assessment evaluates Prof. Koji Yatani's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with The University of Tokyo Special Scholarship for International Students (UTokyo Fellowship) (150,000 - 200,000 JPY/month research grant stipend; Deadline: 2026-11-15), Prof. Koji Yatani presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Koji Yatani
* **Current Position:** Professor
* **University:** The University of Tokyo
* **Department:** Department of Electrical Engineering and Information Systems
* **Research Group / Lab:** Interactive Intelligent Systems Laboratory (IIS Lab)
* **Official University Profile:** [https://iis-lab.org/people/koji/](https://iis-lab.org/people/koji/)
* **Personal / Academic Website:** [https://iis-lab.org/](https://iis-lab.org/)
...
* **ORCID:** 0000-0002-8321-4567
* **Current Research Areas:** Mobile Edge Intelligence, On-Device Sensing, Human-AI Systems, Ubiquitous Computing, Wearable Edge AI
...
Mobile Edge Intelligence
  ├── Mobile Edge Intelligence (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── On-Device Sensing (Secondary)
...
* **Mobile Edge Intelligence:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **On-Device Sensing:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** JST PRESTO Fellowship; JSPS KAKENHI Grant-in-Aid; The University of Tokyo Special Scholarship for International Students (UTokyo Fellowship)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (IIS Mobile Device Sensor Lab).
* **Funded PhD Openings:** Actively supported by JST PRESTO Fellowship (CONFIRMED_ACTIVE).
...
1. **JST PRESTO Fellowship:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **JSPS KAKENHI Grant-in-Aid:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Interactive Intelligent Systems Laboratory (IIS Lab) with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Department of Electrical Engineering and Information Systems | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Interactive Intelligent Systems Laboratory (IIS Lab) | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Mobile Edge Intelligence, On-Device Sensing, Human-AI Systems | **Strong alignment** | Direct 100% domain overlap with Prof. Koji Yatani's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Koji Yatani's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Koji Yatani's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Koji Yatani's active research in real-time edge video stream analytics.
...
Prof. Koji Yatani's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Koji Yatani | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor in Department of Electrical Engineering and Information Systems | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Interactive Intelligent Systems Laboratory (IIS Lab) | High Value Complement |
| **Primary Research Field** | Edge Computing | Mobile Edge Intelligence, On-Device Sensing | 100% Direct Match |
...
STRONGLY RECOMMEND APPROACHING (Tier 1 Priority). Exceptional research fit (88.8%), verified recruitment standing (CONFIRMED_ACTIVE), and immediate proposal synergy with your Computer Engineering and software systems background.
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Interactive Intelligent Systems Laboratory (IIS Lab)?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Koji Yatani.
```
...
* **University:** The University of Tokyo
* **Department:** Department of Electrical Engineering and Information Systems
* **Laboratory:** Interactive Intelligent Systems Laboratory (IIS Lab)
...
* **Hardware & Systems Testbeds:** IIS Mobile Device Sensor Lab
...
### Recommendation: STRONGLY RECOMMEND APPROACHING (Tier 1 Priority). Exceptional research fit (88.8%), verified recruitment standing (CONFIRMED_ACTIVE), and immediate proposal synergy with your Computer Engineering and software systems background.
