...
**Target Professor:** Prof. Hiroki Matsutani  
...
Prof. Hiroki Matsutani is a prominent researcher in Edge AI Hardware Accelerators at Keio University (Japan), directing research within the Adaptive Computing Systems Laboratory. This assessment evaluates Prof. Hiroki Matsutani's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Japanese Government (MEXT) Doctoral Scholarship (University & Embassy Track) (145,000 - 148,000 JPY/month tax-free living allowance + roundtrip international airfare; Deadline: 2026-11-30), Prof. Hiroki Matsutani presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Hiroki Matsutani
* **Current Position:** Professor
* **University:** Keio University
* **Department:** Department of Information and Computer Science
* **Research Group / Lab:** Adaptive Computing Systems Laboratory
* **Official University Profile:** [https://www.arc.ics.keio.ac.jp/~matutani/](https://www.arc.ics.keio.ac.jp/~matutani/)
* **Personal / Academic Website:** [https://www.arc.ics.keio.ac.jp/](https://www.arc.ics.keio.ac.jp/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=n6xZ-YQAAAAJ](https://scholar.google.com/citations?user=n6xZ-YQAAAAJ)
* **ORCID:** 0000-0002-7654-3210
* **Current Research Areas:** Edge AI Hardware Accelerators, On-Chip Networks (NoC), On-Device Learning, FPGA Edge Systems, Adaptive Computing
...
Edge AI Hardware Accelerators
  ├── Edge AI Hardware Accelerators (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── On-Chip Networks (NoC) (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── Edge AI Hardware Accelerators (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **Edge AI Hardware Accelerators:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **On-Chip Networks (NoC):** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **Edge AI Hardware Accelerators:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
* **Active Projects & Grants:** JST CREST Edge Computing Architecture; JSPS KAKENHI Grants; Japanese Government (MEXT) Doctoral Scholarship (University & Embassy Track)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Keio Adaptive FPGA Edge Testbed, Embedded Xilinx/AMD UltraScale Cluster).
* **Funded PhD Openings:** Actively supported by JST CREST Edge Computing Architecture (CONFIRMED_ACTIVE).
...
1. **JST CREST Edge Computing Architecture:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Adaptive Computing Systems Laboratory with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Adaptive Computing Systems Laboratory | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Edge AI Hardware Accelerators, On-Chip Networks (NoC), On-Device Learning | **Strong alignment** | Direct 100% domain overlap with Prof. Hiroki Matsutani's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Hiroki Matsutani's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Hiroki Matsutani's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Hiroki Matsutani's active research in real-time edge video stream analytics.
...
Prof. Hiroki Matsutani's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Hiroki Matsutani | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor in Department of Information and Computer Science | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Adaptive Computing Systems Laboratory | High Value Complement |
| **Primary Research Field** | Edge Computing | Edge AI Hardware Accelerators, On-Chip Networks (NoC) | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Adaptive Computing Systems Laboratory?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Hiroki Matsutani.
```
