...
**Target Professor:** Prof. Raouf Boutaba  
...
Prof. Raouf Boutaba is a prominent researcher in Network Softwarization at University of Waterloo (Canada), directing research within the Network Softwarization and Systems Laboratory. This assessment evaluates Prof. Raouf Boutaba's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Vanier Canada Graduate Scholarships (Vanier CGS) (CAD $50,000/year tax-free stipend + Spousal Open Work Permit (SOWP) eligibility; Deadline: 2026-11-01), Prof. Raouf Boutaba presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Raouf Boutaba
* **Current Position:** Professor & Director of the Cheriton School of Computer Science
* **University:** University of Waterloo
* **Department:** David R. Cheriton School of Computer Science
* **Research Group / Lab:** Network Softwarization and Systems Laboratory
* **Official University Profile:** [https://cs.uwaterloo.ca/~rboutaba/](https://cs.uwaterloo.ca/~rboutaba/)
* **Personal / Academic Website:** [https://cs.uwaterloo.ca/about/people/rboutaba](https://cs.uwaterloo.ca/about/people/rboutaba)
...
* **ORCID:** 0000-0002-3921-7788
* **Current Research Areas:** Network Softwarization, 5G/6G Edge Computing, Network Slicing, Resource Management, AI for Networks
* **Academic Standing:** Professor & Director of the Cheriton School of Computer Science (Tier 1 in Canada Edge Computing landscape)
...
Network Softwarization
  ├── Network Softwarization (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── 5G/6G Edge Computing (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── AI for Networks (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **Network Softwarization:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **5G/6G Edge Computing:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **AI for Networks:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
* **Active Projects & Grants:** NSERC Discovery Grant; Ontario Research Fund (ORF); Rogers Telecom Partnerships
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Waterloo 5G/Edge Testbed, SAVI National Edge Testbed).
* **Funded PhD Openings:** Actively supported by NSERC Discovery Grant (CONFIRMED_ACTIVE).
...
2. **Ontario Research Fund (ORF):** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Rogers Telecom Partnerships:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
4. **Vanier Canada Graduate Scholarships (Vanier CGS):** Provider: Government of Canada (CIHR, NSERC, SSHRC) (FULLY_FUNDED). Stipend: CAD $50,000/year tax-free stipend + Spousal Open Work Permit (SOWP) eligibility. Deadline: 2026-11-01.
5. **Guaranteed Minimum Doctoral Funding Package (Research & Teaching Assistantships):** Provider: University Graduate Studies & Faculty Research Grants (NSERC Discovery Grants) (FULLY_FUNDED). Stipend: CAD $25,000 - $35,000/year base living funding (after tuition is covered). Deadline: 2026-12-15.

---

## 15. PhD Supervision Analysis

* **Research Group Culture:** Collaborative, lab-based culture in Network Softwarization and Systems Laboratory with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in David R. Cheriton School of Computer Science | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Network Softwarization and Systems Laboratory | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Network Softwarization, 5G/6G Edge Computing, Network Slicing | **Strong alignment** | Direct 100% domain overlap with Prof. Raouf Boutaba's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Raouf Boutaba's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Raouf Boutaba's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Raouf Boutaba's active research in real-time edge video stream analytics.
...
Prof. Raouf Boutaba's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Raouf Boutaba | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor & Director of the Cheriton School of Computer Science in David R. Cheriton School of Computer Science | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Network Softwarization and Systems Laboratory | High Value Complement |
| **Primary Research Field** | Edge Computing | Network Softwarization, 5G/6G Edge Computing | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Network Softwarization and Systems Laboratory?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Raouf Boutaba.
```
...
* **University:** University of Waterloo
* **Department:** David R. Cheriton School of Computer Science
* **Laboratory:** Network Softwarization and Systems Laboratory
* **Associated Research Centers:** Network Softwarization Lab, Waterloo Artificial Intelligence Institute, Systems and Networking Group
* **Hardware & Systems Testbeds:** Waterloo 5G/Edge Testbed, SAVI National Edge Testbed
* **Graduate School:** [https://uwaterloo.ca/graduate-studies-postdoctoral-affairs/](https://uwaterloo.ca/graduate-studies-postdoctoral-affairs/)
...
* **Ontario Research Fund (ORF):** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Spouses/common-law partners of full-time doctoral (PhD) stud | Deadline: Aligned with faculty recruitment cycle
* **Rogers Telecom Partnerships:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Spouses/common-law partners of full-time doctoral (PhD) stud | Deadline: Aligned with faculty recruitment cycle
