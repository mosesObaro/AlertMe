...
Prof. Di Niu is a prominent researcher in Distributed Machine Learning at University of Alberta (Canada), directing research within the Distributed Intelligence and Machine Learning Group. This assessment evaluates Prof. Di Niu's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Vanier Canada Graduate Scholarships (Vanier CGS) (CAD $50,000/year tax-free stipend + Spousal Open Work Permit (SOWP) eligibility; Deadline: 2026-11-01), Prof. Di Niu presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Di Niu
* **Current Position:** Professor
* **University:** University of Alberta
* **Department:** Department of Computing Science / Department of ECE
* **Research Group / Lab:** Distributed Intelligence and Machine Learning Group
* **Official University Profile:** [https://apps.ualberta.ca/directory/person/dniu](https://apps.ualberta.ca/directory/person/dniu)
* **Personal / Academic Website:** [https://sites.google.com/ualberta.ca/diniu/](https://sites.google.com/ualberta.ca/diniu/)
...
* **ORCID:** 0000-0002-3921-9876
* **Current Research Areas:** Distributed Machine Learning, Edge AI Inference, Federated Learning, Cloud-Edge Resource Allocation, Natural Language Processing Systems
...
Distributed Machine Learning
  ├── Distributed Machine Learning (Primary)
...
* **Distributed Machine Learning:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
...
* **Active Projects & Grants:** NSERC Discovery Grant; Alberta Innovates; Amii Research Fellow
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Alberta Distributed AI GPU Cluster).
...
2. **Alberta Innovates:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Amii Research Fellow:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Distributed Intelligence and Machine Learning Group with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Department of Computing Science / Department of ECE | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Distributed Intelligence and Machine Learning Group | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Distributed Machine Learning, Edge AI Inference, Federated Learning | **Strong alignment** | Direct 100% domain overlap with Prof. Di Niu's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Di Niu's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Di Niu's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Di Niu's active research in real-time edge video stream analytics.
...
Prof. Di Niu's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Di Niu | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor in Department of Computing Science / Department of ECE | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Distributed Intelligence and Machine Learning Group | High Value Complement |
| **Primary Research Field** | Edge Computing | Distributed Machine Learning, Edge AI Inference | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Distributed Intelligence and Machine Learning Group?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Di Niu.
```
...
* **University:** University of Alberta
* **Department:** Department of Computing Science / Department of ECE
* **Laboratory:** Distributed Intelligence and Machine Learning Group
* **Associated Research Centers:** Alberta Machine Intelligence Institute (Amii), Mobile Systems Laboratory
* **Hardware & Systems Testbeds:** Alberta Distributed AI GPU Cluster
* **Graduate School:** [https://www.ualberta.ca/graduate-studies/index.html](https://www.ualberta.ca/graduate-studies/index.html)
...
* **Alberta Innovates:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Spouses/common-law partners of full-time doctoral (PhD) stud | Deadline: Aligned with faculty recruitment cycle
* **Amii Research Fellow:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Spouses/common-law partners of full-time doctoral (PhD) stud | Deadline: Aligned with faculty recruitment cycle
