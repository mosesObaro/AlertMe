...
**Target Professor:** Prof. Karthik Pattabiraman  
...
Prof. Karthik Pattabiraman is a prominent researcher in Fault Tolerance in Edge Computing at University of British Columbia (Canada), directing research within the Dependable Systems Laboratory (DSL). This assessment evaluates Prof. Karthik Pattabiraman's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Vanier Canada Graduate Scholarships (Vanier CGS) (CAD $50,000/year tax-free stipend + Spousal Open Work Permit (SOWP) eligibility; Deadline: 2026-11-01), Prof. Karthik Pattabiraman presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Karthik Pattabiraman
* **Current Position:** Professor
* **University:** University of British Columbia
* **Department:** Department of Electrical and Computer Engineering
* **Research Group / Lab:** Dependable Systems Laboratory (DSL)
* **Official University Profile:** [https://ece.ubc.ca/karthik-pattabiraman/](https://ece.ubc.ca/karthik-pattabiraman/)
* **Personal / Academic Website:** [https://blogs.ubc.ca/karthik/](https://blogs.ubc.ca/karthik/)
...
* **ORCID:** 0000-0002-3498-7654
* **Current Research Areas:** Fault Tolerance in Edge Computing, IoT Security, Software Reliability, Dependable Edge AI, Silent Data Corruption
* **Academic Standing:** Professor (Tier 1 in Canada Edge Computing landscape)
...
Prof. Karthik Pattabiraman's research career spans over 1 years of systems evolution, transitioning from early foundational systems (2025–2033) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2021–2025).
...
Fault Tolerance in Edge Computing
  ├── Fault Tolerance in Edge Computing (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── IoT Security (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── Dependable Edge AI (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **Fault Tolerance in Edge Computing:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **IoT Security:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **Dependable Edge AI:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
### 1. OneOS: Distributed Operating System for the Edge-to-Cloud Continuum
* **Year:** 2025
* **Venue:** IEEE Transactions on Parallel and Distributed Systems
* **DOI / Link:** [https://doi.org/10.1109/tpds.2025.3557747](https://doi.org/10.1109/tpds.2025.3557747)
* **Problem Addressed:** Edge-to-cloud developers write glue code to bridge framework-specific APIs, which hurts interoperability and fragments the technology stack.
* **Approach:** A middleware-based distributed operating system that presents a single system image of the edge-to-cloud platform and makes components interoperate transparently.
* **Key Contribution:** OneOS, a design for building edge-to-cloud applications without framework-specific glue code.
...
* **Active Projects & Grants:** NSERC Discovery Accelerator Supplement; Google Research Award; Vanier Canada Graduate Scholarships (Vanier CGS)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (UBC Dependable IoT Edge Testbed).
* **Funded PhD Openings:** Actively supported by NSERC Discovery Accelerator Supplement (CONFIRMED_ACTIVE).
...
* **Institutional Collaborators:** Kumseok Jung, Julien Gascon‐Samson, Sathish Gopalakrishnan
...
1. **NSERC Discovery Accelerator Supplement:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Google Research Award:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Vanier Canada Graduate Scholarships (Vanier CGS):** Provider: Government of Canada (CIHR, NSERC, SSHRC) (FULLY_FUNDED). Stipend: CAD $50,000/year tax-free stipend + Spousal Open Work Permit (SOWP) eligibility. Deadline: 2026-11-01.
4. **Guaranteed Minimum Doctoral Funding Package (Research & Teaching Assistantships):** Provider: University Graduate Studies & Faculty Research Grants (NSERC Discovery Grants) (FULLY_FUNDED). Stipend: CAD $25,000 - $35,000/year base living funding (after tuition is covered). Deadline: 2026-12-15.

---

## 15. PhD Supervision Analysis

* **Research Group Culture:** Collaborative, lab-based culture in Dependable Systems Laboratory (DSL) with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Dependable Systems Laboratory (DSL) | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Fault Tolerance in Edge Computing, IoT Security, Software Reliability | **Strong alignment** | Direct 100% domain overlap with Prof. Karthik Pattabiraman's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Karthik Pattabiraman's pioneering work in split computing and early-exit networks (OneOS: Distributed Operating System for the Edge-to-Cloud Continuum).
...
* **Professor's Expertise:** Prof. Karthik Pattabiraman's research in decentralized edge computing architectures (OneOS: Distributed Operating System for the Edge-to-Cloud Continuum).
...
* **Professor's Expertise:** Prof. Karthik Pattabiraman's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Karthik Pattabiraman's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Karthik Pattabiraman's active research in real-time edge video stream analytics.
...
Prof. Karthik Pattabiraman's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Karthik Pattabiraman | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor in Department of Electrical and Computer Engineering | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Dependable Systems Laboratory (DSL) | High Value Complement |
| **Primary Research Field** | Edge Computing | Fault Tolerance in Edge Computing, IoT Security | 100% Direct Match |
| **AI / ML Focus** | Edge AI / TinyML / Distributed ML | Split DNN Inference, Model Compression, Edge Intelligence | Strong Alignment |
| **Target Funding Scheme** | Competitive Doctoral Scholarship / Studentship | Eligible for Vanier Canada Graduate Scholarships (Vanier CGS) | Prime Synergy |
...
1. In your recent work on 'OneOS: Distributed Operating System for the Edge-to-Cloud Continuum', what is the primary systems bottleneck when scaling across heterogeneous devices with different neural hardware accelerators?
...
3. How are doctoral research topics typically structured in Dependable Systems Laboratory (DSL)—do incoming PhD students formulate their own proposals or integrate into specific funded grant milestones?
...
5. What criteria and milestones do you prioritize when nominating prospective doctoral applicants for the Vanier Canada Graduate Scholarships (Vanier CGS)?
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Dependable Systems Laboratory (DSL)?
...
### Tier 1 — Must Read
1. *OneOS: Distributed Operating System for the Edge-to-Cloud Continuum* (IEEE Transactions on Parallel and Distributed Systems, 2025)

### Tier 2 — Research Evolution
2. *OneOS: Distributed Operating System for the Edge-to-Cloud Continuum* (IEEE Transactions on Parallel and Distributed Systems, 2025)

### Tier 3 — PhD Alignment
3. *OneOS: Distributed Operating System for the Edge-to-Cloud Continuum* (IEEE Transactions on Parallel and Distributed Systems, 2025)
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Karthik Pattabiraman.
```
...
* **University:** University of British Columbia
* **Department:** Department of Electrical and Computer Engineering
* **Laboratory:** Dependable Systems Laboratory (DSL)
* **Associated Research Centers:** Dependable Systems Lab, Institute for Computing, Information and Cognitive Systems (ICICS)
* **Hardware & Systems Testbeds:** UBC Dependable IoT Edge Testbed
* **Graduate School:** [https://www.grad.ubc.ca/](https://www.grad.ubc.ca/)

---

## 29. Funding Opportunities, Pathways & Eligibility
* **NSERC Discovery Accelerator Supplement:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Spouses/common-law partners of full-time doctoral (PhD) stud | Deadline: Aligned with faculty recruitment cycle
* **Google Research Award:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Spouses/common-law partners of full-time doctoral (PhD) stud | Deadline: Aligned with faculty recruitment cycle
* **Vanier Canada Graduate Scholarships (Vanier CGS):** Provider: Government of Canada (CIHR, NSERC, SSHRC) | Type: FULLY_FUNDED | Stipend: CAD $50,000/year tax-free stipend + Spousal Open Work Permit (SOWP) eligibility | Tuition: Full tuition waivers typically awarded alongside fellowship by host institution | Duration: 3 years | International Eligibility: ELIGIBLE | Dependant Support: GOOD | Deadline: 2026-11-01
* **Guaranteed Minimum Doctoral Funding Package (Research & Teaching Assistantships):** Provider: University Graduate Studies & Faculty Research Grants (NSERC Discovery Grants) | Type: FULLY_FUNDED | Stipend: CAD $25,000 - $35,000/year base living funding (after tuition is covered) | Tuition: Full international tuition differential fee waiver or reimbursement | Duration: 4 to 5 years guaranteed | International Eligibility: ELIGIBLE | Dependant Support: GOOD | Deadline: 2026-12-15
...
Prof. Karthik Pattabiraman is an active academic authority at University of British Columbia, leading research within the Dependable Systems Laboratory (DSL). Over a prolific academic trajectory spanning from 2025 to 2025, Prof. Karthik Pattabiraman has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Karthik Pattabiraman is primarily a researcher in Fault Tolerance in Edge Computing, with expertise spanning IoT Security, Software Reliability, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."
...
* **[FACT]** Official Faculty Profile: https://ece.ubc.ca/karthik-pattabiraman/
* **[FACT]** Recruitment Verification Record: 'Looking for talented PhD students interested in dependable systems, software reliability, and edge IoT security.' (Source: official_lab_website, Date: 2026-01-20)
