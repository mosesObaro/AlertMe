...
**Target Professor:** Prof. Seif Haridi  
...
Prof. Seif Haridi is a prominent researcher in Decentralized Edge Systems at KTH Royal Institute of Technology (Sweden), directing research within the Distributed and Decentralized Computing Systems Lab. This assessment evaluates Prof. Seif Haridi's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Swedish Salaried Doctoral Position (Doktorandanställning) (31,000 - 35,500 SEK/month gross employment salary (regulated by collective bargaining agreements) + full statutory pension, paid vacation (28 days/yr), healthcare, and parental leave benefits; Deadline: 2026-12-01), Prof. Seif Haridi presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Seif Haridi
* **Current Position:** Professor of Computer Systems & Chief Scientist at RISE
* **University:** KTH Royal Institute of Technology
* **Department:** School of Electrical Engineering and Computer Science (EECS)
* **Research Group / Lab:** Distributed and Decentralized Computing Systems Lab
* **Official University Profile:** [https://www.kth.se/profile/haridi](https://www.kth.se/profile/haridi)
* **Personal / Academic Website:** [https://people.kth.se/~haridi/](https://people.kth.se/~haridi/)
...
* **ORCID:** 0000-0002-9876-1234
* **Current Research Areas:** Decentralized Edge Systems, Scale-Out Distributed Computing, Edge Machine Learning, Peer-to-Peer Computing, Distributed AI Systems
* **Academic Standing:** Professor of Computer Systems & Chief Scientist at RISE (Tier 1 in Sweden Edge Computing landscape)
...
Decentralized Edge Systems
  ...
  ├── Scale-Out Distributed Computing (Secondary)
...
* **Scale-Out Distributed Computing:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** Wallenberg AI Autonomous Systems Program (WASP); EU Horizon Europe Projects; Swedish Salaried Doctoral Position (Doktorandanställning)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (KTH Scale-Out Systems Testbed, RISE ICE Datacenter Testbed).
* **Funded PhD Openings:** Actively supported by Wallenberg AI Autonomous Systems Program (WASP) (CONFIRMED_ACTIVE).
...
1. **Wallenberg AI Autonomous Systems Program (WASP):** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **EU Horizon Europe Projects:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Distributed and Decentralized Computing Systems Lab with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Distributed and Decentralized Computing Systems Lab | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Decentralized Edge Systems, Scale-Out Distributed Computing, Edge Machine Learning | **Strong alignment** | Direct 100% domain overlap with Prof. Seif Haridi's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Seif Haridi's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Seif Haridi's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Seif Haridi's active research in real-time edge video stream analytics.
...
Prof. Seif Haridi's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Seif Haridi | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Computer Systems & Chief Scientist at RISE in School of Electrical Engineering and Computer Science (EECS) | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Distributed and Decentralized Computing Systems Lab | High Value Complement |
| **Primary Research Field** | Edge Computing | Decentralized Edge Systems, Scale-Out Distributed Computing | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Distributed and Decentralized Computing Systems Lab?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Seif Haridi.
```
...
* **Hardware & Systems Testbeds:** KTH Scale-Out Systems Testbed, RISE ICE Datacenter Testbed
