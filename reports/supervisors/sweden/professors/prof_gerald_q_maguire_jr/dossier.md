...
**Target Professor:** Prof. Gerald Q. Maguire Jr.  
...
Prof. Gerald Q. Maguire Jr. is a prominent researcher in Mobile Edge Computing at KTH Royal Institute of Technology (Sweden), directing research within the Communication Systems Division. This assessment evaluates Prof. Gerald Q. Maguire Jr.'s academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Swedish Salaried Doctoral Position (Doktorandanställning) (31,000 - 35,500 SEK/month gross employment salary (regulated by collective bargaining agreements) + full statutory pension, paid vacation (28 days/yr), healthcare, and parental leave benefits; Deadline: 2026-12-01), Prof. Gerald Q. Maguire Jr. presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Gerald Q. Maguire Jr.
* **Current Position:** Professor of Computer Communication
* **University:** KTH Royal Institute of Technology
* **Department:** School of Electrical Engineering and Computer Science (EECS)
* **Research Group / Lab:** Communication Systems Division
* **Official University Profile:** [https://www.kth.se/profile/maguire](https://www.kth.se/profile/maguire)
* **Personal / Academic Website:** [https://people.kth.se/~maguire/](https://people.kth.se/~maguire/)
...
* **ORCID:** 0000-0002-8654-7890
* **Current Research Areas:** Mobile Edge Computing, Internet of Things, Wireless Communication Systems, Pervasive Computing, Edge Sensing Platforms
* **Academic Standing:** Professor of Computer Communication (Tier 1 in Sweden Edge Computing landscape)
...
Prof. Gerald Q. Maguire Jr.'s research career spans over 1 years of systems evolution, transitioning from early foundational systems (2023–2031) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2019–2023).
...
Mobile Edge Computing
  ├── Mobile Edge Computing (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Internet of Things (Secondary)
...
* **Mobile Edge Computing:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Internet of Things:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
### 1. Low-Power Wide-Area Networks for Edge IoT Computing: Architectures, Protocols, and Real-World Performance
* **Year:** 2023
* **Venue:** IEEE Internet of Things Journal
* **DOI / Link:** [https://doi.org/10.1109/JIOT.2023.3278901](https://doi.org/10.1109/JIOT.2023.3278901)
* **Problem Addressed:** Enabling edge computation offloading over bandwidth-constrained sub-GHz LoRa and cellular IoT links.
* **Approach:** Adaptive hierarchical feature aggregation at field gateways before WAN transmission.
* **Key Contribution:** Extends sensor node operational battery life from months to over 8 years.
...
* **Active Projects & Grants:** Swedish Research Council (VR) Grants; KTH Digital Futures Projects; Swedish Salaried Doctoral Position (Doktorandanställning)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (KTH Wireless Edge Campus Testbed).
* **Funded PhD Openings:** Actively supported by Swedish Research Council (VR) Grants (CONFIRMED_ACTIVE).
...
* **Institutional Collaborators:** G. Q. Maguire Jr., F. Ramirez
...
1. **Swedish Research Council (VR) Grants:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **KTH Digital Futures Projects:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Communication Systems Division with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Communication Systems Division | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Mobile Edge Computing, Internet of Things, Wireless Communication Systems | **Strong alignment** | Direct 100% domain overlap with Prof. Gerald Q. Maguire Jr.'s active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Gerald Q. Maguire Jr.'s pioneering work in split computing and early-exit networks (Low-Power Wide-Area Networks for Edge IoT Computing: Architectures, Protocols, and Real-World Performance).
...
* **Professor's Expertise:** Prof. Gerald Q. Maguire Jr.'s research in decentralized edge computing architectures (Low-Power Wide-Area Networks for Edge IoT Computing: Architectures, Protocols, and Real-World Performance).
...
* **Professor's Expertise:** Prof. Gerald Q. Maguire Jr.'s focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Gerald Q. Maguire Jr.'s long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Gerald Q. Maguire Jr.'s active research in real-time edge video stream analytics.
...
Prof. Gerald Q. Maguire Jr.'s research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Gerald Q. Maguire Jr. | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Computer Communication in School of Electrical Engineering and Computer Science (EECS) | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Communication Systems Division | High Value Complement |
| **Primary Research Field** | Edge Computing | Mobile Edge Computing, Internet of Things | 100% Direct Match |
...
1. In your recent work on 'Low-Power Wide-Area Networks for Edge IoT Computing: Architectures, Protocols, and Real-World Performance', what is the primary systems bottleneck when scaling across heterogeneous devices with different neural hardware accelerators?
...
3. How are doctoral research topics typically structured in Communication Systems Division—do incoming PhD students formulate their own proposals or integrate into specific funded grant milestones?
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Communication Systems Division?
...
### Tier 1 — Must Read
1. *Low-Power Wide-Area Networks for Edge IoT Computing: Architectures, Protocols, and Real-World Performance* (IEEE Internet of Things Journal, 2023)

### Tier 2 — Research Evolution
2. *Low-Power Wide-Area Networks for Edge IoT Computing: Architectures, Protocols, and Real-World Performance* (IEEE Internet of Things Journal, 2023)

### Tier 3 — PhD Alignment
3. *Low-Power Wide-Area Networks for Edge IoT Computing: Architectures, Protocols, and Real-World Performance* (IEEE Internet of Things Journal, 2023)
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Gerald Q. Maguire Jr..
```
...
* **Hardware & Systems Testbeds:** KTH Wireless Edge Campus Testbed
...
Prof. Gerald Q. Maguire Jr. is an active academic authority at KTH Royal Institute of Technology, leading research within the Communication Systems Division. Over a prolific academic trajectory spanning from 2023 to 2023, Prof. Gerald Q. Maguire Jr. has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Gerald Q. Maguire Jr. is primarily a researcher in Mobile Edge Computing, with expertise spanning Internet of Things, Wireless Communication Systems, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."
...
* **[FACT]** Official Faculty Profile: https://www.kth.se/profile/maguire
* **[FACT]** Recruitment Verification Record: 'Supervises doctoral candidates with Swedish salaried employment contracts through KTH EECS doctoral school.' (Source: official_lab_website, Date: 2026-01-10)
