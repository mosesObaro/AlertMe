...
**Target Professor:** Prof. Erik Elmroth  
...
Prof. Erik Elmroth is a prominent researcher in Autonomous Cloud-Edge Systems at Umeå University (Sweden), directing research within the Autonomous Distributed Systems Laboratory. This assessment evaluates Prof. Erik Elmroth's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Swedish Salaried Doctoral Position (Doktorandanställning) (31,000 - 35,500 SEK/month gross employment salary (regulated by collective bargaining agreements) + full statutory pension, paid vacation (28 days/yr), healthcare, and parental leave benefits; Deadline: 2026-12-01), Prof. Erik Elmroth presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Erik Elmroth
* **Current Position:** Professor of Computing Science & Head of Department
* **University:** Umeå University
* **Department:** Department of Computing Science
* **Research Group / Lab:** Autonomous Distributed Systems Laboratory
* **Official University Profile:** [https://www.umu.se/en/staff/erik-elmroth/](https://www.umu.se/en/staff/erik-elmroth/)
* **Personal / Academic Website:** [https://www.cloud-edge.se/](https://www.cloud-edge.se/)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=PZ9S2lQAAAAJ](https://scholar.google.com/citations?user=PZ9S2lQAAAAJ)
* **ORCID:** 0000-0002-3987-1234
* **Current Research Areas:** Autonomous Cloud-Edge Systems, Edge Cloud Orchestration, Serverless Edge, Autonomous Resource Management, Distributed Systems
* **Academic Standing:** Professor of Computing Science & Head of Department (Tier 1 in Sweden Edge Computing landscape)
...
Prof. Erik Elmroth's research career spans over 1 years of systems evolution, transitioning from early foundational systems (2023–2031) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2019–2023).
...
```text
Autonomous Cloud-Edge Systems
  ├── Autonomous Cloud-Edge Systems (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Edge Cloud Orchestration (Secondary)
...
* **Autonomous Cloud-Edge Systems:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Edge Cloud Orchestration:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
### 1. Robust Procedural Learning for Anomaly Detection and Observability in 5G RAN
* **Year:** 2023
* **Venue:** IEEE Transactions on Network and Service Management
* **DOI / Link:** [https://doi.org/10.1109/tnsm.2023.3321401](https://doi.org/10.1109/tnsm.2023.3321401)
* **Problem Addressed:** Large distributed systems such as the 5G RAN have unstructured logs without the context needed to learn system behaviour for anomaly detection.
* **Approach:** A trace guideline that splits system logs by component and procedure, so models can learn behaviour from smaller, contextualised pieces.
* **Key Contribution:** A fast dictionary-based detector that finds all anomalies with near-zero false positives where prior methods struggled, improving RAN observability.
...
* **Active Projects & Grants:** WASP Research Grant; Swedish Research Council (VR); EU Horizon Research Grants
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Umeå Autonomous Distributed Systems Testbed, HPC2N Supercomputing Center).
...
* **Institutional Collaborators:** Tobias Sundqvist, Monowar H. Bhuyan
...
3. **EU Horizon Research Grants:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Autonomous Distributed Systems Laboratory with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Department of Computing Science | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Autonomous Distributed Systems Laboratory | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Autonomous Cloud-Edge Systems, Edge Cloud Orchestration, Serverless Edge | **Strong alignment** | Direct 100% domain overlap with Prof. Erik Elmroth's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Erik Elmroth's pioneering work in split computing and early-exit networks (Robust Procedural Learning for Anomaly Detection and Observability in 5G RAN).
...
* **Professor's Expertise:** Prof. Erik Elmroth's research in decentralized edge computing architectures (Robust Procedural Learning for Anomaly Detection and Observability in 5G RAN).
...
* **Professor's Expertise:** Prof. Erik Elmroth's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Erik Elmroth's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Erik Elmroth's active research in real-time edge video stream analytics.
...
Prof. Erik Elmroth's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Erik Elmroth | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Computing Science & Head of Department in Department of Computing Science | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Autonomous Distributed Systems Laboratory | High Value Complement |
| **Primary Research Field** | Edge Computing | Autonomous Cloud-Edge Systems, Edge Cloud Orchestration | 100% Direct Match |
...
1. In your recent work on 'Robust Procedural Learning for Anomaly Detection and Observability in 5G RAN', what is the primary systems bottleneck when scaling across heterogeneous devices with different neural hardware accelerators?
...
3. How are doctoral research topics typically structured in Autonomous Distributed Systems Laboratory—do incoming PhD students formulate their own proposals or integrate into specific funded grant milestones?
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Autonomous Distributed Systems Laboratory?
...
### Tier 1 — Must Read
1. *Robust Procedural Learning for Anomaly Detection and Observability in 5G RAN* (IEEE Transactions on Network and Service Management, 2023)

### Tier 2 — Research Evolution
2. *Robust Procedural Learning for Anomaly Detection and Observability in 5G RAN* (IEEE Transactions on Network and Service Management, 2023)

### Tier 3 — PhD Alignment
3. *Robust Procedural Learning for Anomaly Detection and Observability in 5G RAN* (IEEE Transactions on Network and Service Management, 2023)
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Erik Elmroth.
```
...
* **University:** Umeå University
* **Department:** Department of Computing Science
* **Laboratory:** Autonomous Distributed Systems Laboratory
* **Associated Research Centers:** High Performance Computing Center North (HPC2N), WASP AI and Cloud Center
* **Hardware & Systems Testbeds:** Umeå Autonomous Distributed Systems Testbed, HPC2N Supercomputing Center
* **Graduate School:** [https://www.umu.se/en/education/doctoral-studies/](https://www.umu.se/en/education/doctoral-studies/)
...
* **EU Horizon Research Grants:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Doctoral positions in Sweden are classified as salaried empl | Deadline: Aligned with faculty recruitment cycle
...
Prof. Erik Elmroth is an active academic authority at Umeå University, leading research within the Autonomous Distributed Systems Laboratory. Over a prolific academic trajectory spanning from 2023 to 2023, Prof. Erik Elmroth has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Erik Elmroth is primarily a researcher in Autonomous Cloud-Edge Systems, with expertise spanning Edge Cloud Orchestration, Serverless Edge, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."
...
* **[FACT]** Official Faculty Profile: https://www.umu.se/en/staff/erik-elmroth/
* **[FACT]** Recruitment Verification Record: 'Continuously recruiting doctoral researchers (salaried positions) in autonomous cloud-edge systems and distributed resource management.' (Source: official_lab_website, Date: 2026-01-20)
