...
**Target Professor:** Prof. Johan Eker  
...
Prof. Johan Eker is a prominent researcher in Cloud-Edge Automation at Lund University / Ericsson Research (Sweden), directing research within the Real-Time Computing and Edge Automation Group. This assessment evaluates Prof. Johan Eker's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Swedish Salaried Doctoral Position (Doktorandanställning) (31,000 - 35,500 SEK/month gross employment salary (regulated by collective bargaining agreements) + full statutory pension, paid vacation (28 days/yr), healthcare, and parental leave benefits; Deadline: 2026-12-01), Prof. Johan Eker presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Johan Eker
* **Current Position:** Adjunct Professor at Lund University & Principal Researcher at Ericsson Research
* **University:** Lund University / Ericsson Research
* **Department:** Department of Automatic Control / Department of Computer Science
* **Research Group / Lab:** Real-Time Computing and Edge Automation Group
* **Official University Profile:** [https://www.control.lth.se/staff/johan-eker/](https://www.control.lth.se/staff/johan-eker/)
* **Personal / Academic Website:** [https://www.ericsson.com/en/about-us/research/authors/johan-eker](https://www.ericsson.com/en/about-us/research/authors/johan-eker)
...
* **ORCID:** 0000-0002-1234-9876
* **Current Research Areas:** Cloud-Edge Automation, Real-Time Control Systems, Fog Computing, Edge Cloud Slicing, Embedded Software
* **Academic Standing:** Adjunct Professor at Lund University & Principal Researcher at Ericsson Research (Tier 1 in Sweden Edge Computing landscape)
...
Cloud-Edge Automation
  ├── Cloud-Edge Automation (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Real-Time Control Systems (Secondary)
...
* **Cloud-Edge Automation:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Real-Time Control Systems:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
* **Active Projects & Grants:** ELLIIT Strategic Research Area; WASP Research Program; Ericsson Research Grants
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Lund ELLIIT Edge Testbed, Ericsson Global Edge Lab).
* **Funded PhD Openings:** Actively supported by ELLIIT Strategic Research Area (CONFIRMED_ACTIVE).
...
1. **ELLIIT Strategic Research Area:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **WASP Research Program:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Ericsson Research Grants:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Real-Time Computing and Edge Automation Group with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Department of Automatic Control / Department of Computer Science | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Real-Time Computing and Edge Automation Group | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Cloud-Edge Automation, Real-Time Control Systems, Fog Computing | **Strong alignment** | Direct 100% domain overlap with Prof. Johan Eker's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Johan Eker's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Johan Eker's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Johan Eker's active research in real-time edge video stream analytics.
...
Prof. Johan Eker's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Johan Eker | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Adjunct Professor at Lund University & Principal Researcher at Ericsson Research in Department of Automatic Control / Department of Computer Science | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Real-Time Computing and Edge Automation Group | High Value Complement |
| **Primary Research Field** | Edge Computing | Cloud-Edge Automation, Real-Time Control Systems | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Real-Time Computing and Edge Automation Group?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Johan Eker.
```
