...
**Target Professor:** Prof. Sarunas Girdzijauskas  
...
Prof. Sarunas Girdzijauskas is a prominent researcher in Decentralized Machine Learning at KTH Royal Institute of Technology (Sweden), directing research within the Distributed and Decentralized Systems Lab. This assessment evaluates Prof. Sarunas Girdzijauskas's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Swedish Salaried Doctoral Position (Doktorandanställning) (31,000 - 35,500 SEK/month gross employment salary (regulated by collective bargaining agreements) + full statutory pension, paid vacation (28 days/yr), healthcare, and parental leave benefits; Deadline: 2026-12-01), Prof. Sarunas Girdzijauskas presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Sarunas Girdzijauskas
* **Current Position:** Professor of Distributed Computing
* **University:** KTH Royal Institute of Technology
* **Department:** School of Electrical Engineering and Computer Science (EECS)
* **Research Group / Lab:** Distributed and Decentralized Systems Lab
* **Official University Profile:** [https://www.kth.se/profile/sarunasg](https://www.kth.se/profile/sarunasg)
* **Personal / Academic Website:** [https://people.kth.se/~sarunasg/](https://people.kth.se/~sarunasg/)
...
* **ORCID:** 0000-0002-7654-9876
* **Current Research Areas:** Decentralized Machine Learning, Federated Learning at Edge, Peer-to-Peer Networks, Distributed Optimization, Edge AI Systems
* **Academic Standing:** Professor of Distributed Computing (Tier 1 in Sweden Edge Computing landscape)
...
Decentralized Machine Learning
  ├── Decentralized Machine Learning (Primary)
  │   └── Decentralized Edge Orchestration
  │   └── Dynamic Task Offloading
  ├── Federated Learning at Edge (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── Federated Learning at Edge (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **Decentralized Machine Learning:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Federated Learning at Edge:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **Federated Learning at Edge:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
* **Active Projects & Grants:** WASP Research Grant; Swedish Research Council (VR); Swedish Salaried Doctoral Position (Doktorandanställning)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (KTH Decentralized Computing Testbed).
...
* **Research Group Culture:** Collaborative, lab-based culture in Distributed and Decentralized Systems Lab with regular systems reading seminars and hardware testbed access.
...
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Distributed and Decentralized Systems Lab | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Decentralized Machine Learning, Federated Learning at Edge, Peer-to-Peer Networks | **Strong alignment** | Direct 100% domain overlap with Prof. Sarunas Girdzijauskas's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Sarunas Girdzijauskas's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Sarunas Girdzijauskas's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Sarunas Girdzijauskas's active research in real-time edge video stream analytics.
...
Prof. Sarunas Girdzijauskas's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Sarunas Girdzijauskas | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Distributed Computing in School of Electrical Engineering and Computer Science (EECS) | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Distributed and Decentralized Systems Lab | High Value Complement |
| **Primary Research Field** | Edge Computing | Decentralized Machine Learning, Federated Learning at Edge | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Distributed and Decentralized Systems Lab?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Sarunas Girdzijauskas.
```
...
* **Hardware & Systems Testbeds:** KTH Decentralized Computing Testbed
