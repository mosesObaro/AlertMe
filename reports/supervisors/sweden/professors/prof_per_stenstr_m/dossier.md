...
**Target Professor:** Prof. Per Stenström  
...
Prof. Per Stenström is a prominent researcher in Computer Architecture at Chalmers University of Technology (Sweden), directing research within the Computer Architecture Division. This assessment evaluates Prof. Per Stenström's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (CONFIRMED_ACTIVE) and direct synergy with Swedish Salaried Doctoral Position (Doktorandanställning) (31,000 - 35,500 SEK/month gross employment salary (regulated by collective bargaining agreements) + full statutory pension, paid vacation (28 days/yr), healthcare, and parental leave benefits; Deadline: 2026-12-01), Prof. Per Stenström presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Per Stenström
* **Current Position:** Professor of Computer Architecture & ACM/IEEE Fellow
* **University:** Chalmers University of Technology
* **Department:** Department of Computer Science and Engineering
* **Research Group / Lab:** Computer Architecture Division
* **Official University Profile:** [https://www.chalmers.se/en/staff/pers/](https://www.chalmers.se/en/staff/pers/)
* **Personal / Academic Website:** [https://www.chalmers.se/en/departments/cse/](https://www.chalmers.se/en/departments/cse/)
...
* **ORCID:** 0000-0002-3921-1122
* **Current Research Areas:** Computer Architecture, Memory Systems for Edge AI, Hardware Accelerators, Parallel Computing, Energy-Efficient Processing
* **Academic Standing:** Professor of Computer Architecture & ACM/IEEE Fellow (Tier 1 in Sweden Edge Computing landscape)
...
Prof. Per Stenström's research career spans over 1 years of systems evolution, transitioning from early foundational systems (2023–2031) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2019–2023).
...
Computer Architecture
  ...
  ├── Memory Systems for Edge AI (Secondary)
  │   └── Fault-Tolerant Architectures
  │   └── Peer-to-Peer Coordination
  └── Memory Systems for Edge AI (Emerging)
      └── Split DNN Inference
      └── Dynamic Early-Exit Neural Networks
```

* **Computer Architecture:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Memory Systems for Edge AI:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
* **Memory Systems for Edge AI:** Emerging. Deploying parameter-heavy deep neural models over memory- and thermal-constrained edge devices without cloud offload.
...
* **Active Projects & Grants:** WASP Research Grant; European Processor Initiative (EPI); Swedish Research Council
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Chalmers Computer Architecture Cluster).
...
2. **European Processor Initiative (EPI):** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Swedish Research Council:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
...
* **Research Group Culture:** Collaborative, lab-based culture in Computer Architecture Division with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Department of Computer Science and Engineering | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Computer Architecture Division | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Computer Architecture, Memory Systems for Edge AI, Hardware Accelerators | **Strong alignment** | Direct 100% domain overlap with Prof. Per Stenström's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Per Stenström's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Per Stenström's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Per Stenström's active research in real-time edge video stream analytics.
...
Prof. Per Stenström's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Per Stenström | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Computer Architecture & ACM/IEEE Fellow in Department of Computer Science and Engineering | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Computer Architecture Division | High Value Complement |
| **Primary Research Field** | Edge Computing | Computer Architecture, Memory Systems for Edge AI | 100% Direct Match |
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Computer Architecture Division?
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Per Stenström.
```
...
* **Associated Research Centers:** Chalmers AI Research Centre (CHAIR), WASP Autonomous Systems Center
* **Hardware & Systems Testbeds:** Chalmers Computer Architecture Cluster
* **Graduate School:** [https://www.chalmers.se/en/education/doctoral-programmes/](https://www.chalmers.se/en/education/doctoral-programmes/)
...
* **European Processor Initiative (EPI):** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Doctoral positions in Sweden are classified as salaried empl | Deadline: Aligned with faculty recruitment cycle
* **Swedish Research Council:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Doctoral positions in Sweden are classified as salaried empl | Deadline: Aligned with faculty recruitment cycle
...
Prof. Per Stenström is an active academic authority at Chalmers University of Technology, leading research within the Computer Architecture Division. Over a prolific academic trajectory spanning from 2023 to 2023, Prof. Per Stenström has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Per Stenström is primarily a researcher in Computer Architecture, with expertise spanning Memory Systems for Edge AI, Hardware Accelerators, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."
...
* **[FACT]** Official Faculty Profile: https://www.chalmers.se/en/staff/pers/
* **[FACT]** Recruitment Verification Record: 'Recruiting doctoral researchers (salaried positions) in computer architecture, edge hardware accelerators, and memory systems.' (Source: official_lab_website, Date: 2026-01-15)
