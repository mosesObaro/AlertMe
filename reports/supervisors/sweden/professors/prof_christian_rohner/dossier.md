...
**Target Professor:** Prof. Christian Rohner  
...
Prof. Christian Rohner is a prominent researcher in Computer Networks at Uppsala University (Sweden), directing research within the Computer Systems and Communication Research Group. This assessment evaluates Prof. Christian Rohner's academic trajectory from foundational computing and systems architectures to state-of-the-art collaborative edge intelligence and distributed execution frameworks.

With verified recruitment standing (STRONG_EVIDENCE) and direct synergy with Swedish Salaried Doctoral Position (Doktorandanställning) (31,000 - 35,500 SEK/month gross employment salary (regulated by collective bargaining agreements) + full statutory pension, paid vacation (28 days/yr), healthcare, and parental leave benefits; Deadline: 2026-12-01), Prof. Christian Rohner presents an outstanding doctoral supervisor opportunity bridging systems engineering, runtime profiling, and Edge AI.

---

## 2. Professor Identity & Academic Profile

* **Full Name:** Prof. Christian Rohner
* **Current Position:** Professor of Computer Networks
* **University:** Uppsala University
* **Department:** Department of Information Technology
* **Research Group / Lab:** Computer Systems and Communication Research Group
* **Official University Profile:** [https://www.katalog.uu.se/profile/?id=N96-1845](https://www.katalog.uu.se/profile/?id=N96-1845)
* **Personal / Academic Website:** [https://www.it.uu.se/research/group/comsys](https://www.it.uu.se/research/group/comsys)
* **Google Scholar / DBLP:** [https://scholar.google.com/citations?user=P3q9p-AAAAAJ](https://scholar.google.com/citations?user=P3q9p-AAAAAJ)
* **ORCID:** 0000-0002-3921-9911
* **Current Research Areas:** Computer Networks, Wireless Sensor Networks, IoT Edge Systems, Low-Power Communication, Opportunistic Edge Computing
* **Academic Standing:** Professor of Computer Networks (Tier 1 in Sweden Edge Computing landscape)
...
Prof. Christian Rohner's research career spans over 1 years of systems evolution, transitioning from early foundational systems (2024–2032) through distributed networking and pervasive architectures, to cutting-edge collaborative Edge AI and intelligent orchestration (2020–2024).
...
Computer Networks
  ...
  ├── Wireless Sensor Networks (Secondary)
...
* **Computer Networks:** Primary. Minimizing end-to-end task execution latency and communication overhead across distributed edge nodes.
* **Wireless Sensor Networks:** Secondary. Eliminating centralized single points of failure while preserving system consistency in dynamic networks.
...
### 1. Non-Negative Decomposition of Multivariate Information: From Minimum to Blackwell-Specific Information
* **Year:** 2024
* **Venue:** Entropy
* **DOI / Link:** [https://doi.org/10.3390/e26050424](https://doi.org/10.3390/e26050424)
* **Problem Addressed:** Partial information decomposition still lacks a suitable non-negative measure for an arbitrary number of discrete variables.
* **Approach:** A pointwise decomposition built on the equivalence of the Blackwell and zonogon orders, applicable to any f-information measure.
* **Key Contribution:** A non-negative decomposition that satisfies the inclusion-exclusion relation and the desired axioms, with proofs.
...
* **Active Projects & Grants:** Swedish Research Council (VR) Grant; Uppsala UPMARC Research Grant; Swedish Salaried Doctoral Position (Doktorandanställning)
* **Current Research Group Direction:** Transitioning from theoretical scheduling algorithms toward runtime deployment on hardware testbeds (Uppsala Wireless IoT Testbed).
* **Funded PhD Openings:** Actively supported by Swedish Research Council (VR) Grant (STRONG_EVIDENCE).
...
* **Institutional Collaborators:** Tobias Mages, Elli Anastasiadi
...
1. **Swedish Research Council (VR) Grant:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
2. **Uppsala UPMARC Research Grant:** Provider: National Research Council / University Research Fund (RESEARCH_GRANT). Stipend: Supports doctoral student stipends & hardware equipment. Deadline: Aligned with faculty recruitment cycle.
3. **Swedish Salaried Doctoral Position (Doktorandanställning):** Provider: Swedish State University System & Swedish Higher Education Ordinance (Högskoleförordningen) (FULLY_FUNDED). Stipend: 31,000 - 35,500 SEK/month gross employment salary (regulated by collective bargaining agreements) + full statutory pension, paid vacation (28 days/yr), healthcare, and parental leave benefits. Deadline: 2026-12-01.
4. **Wallenberg AI, Autonomous Systems and Software Program (WASP) PhD Fellowship:** Provider: Knut and Alice Wallenberg Foundation (KAW) (FULLY_FUNDED). Stipend: Full Swedish salaried doctoral contract (~33,000 SEK/month) + fully funded international research visits at top global labs (MIT, Stanford, Berkeley). Deadline: 2026-11-15.

---

## 15. PhD Supervision Analysis

* **Research Group Culture:** Collaborative, lab-based culture in Computer Systems and Communication Research Group with regular systems reading seminars and hardware testbed access.
...
| :--- | :--- | :--- | :--- |
| **Degree: Computer Engineering (BSc) / CS (MSc)** | Computer systems, networking protocols, and hardware-software testbeds in Department of Information Technology | **Strong alignment** | Strong foundation in computer architecture, operating systems, and discrete mathematics directly matches the professor's systems engineering standards. |
| **Practical Experience: Software & iOS Engineering** | Prototype development and testbed implementation in Computer Systems and Communication Research Group | **Strong alignment** | Production software development fluency allows building robust distributed runtimes, memory profilers, and edge clients rather than purely theoretical simulations. |
| **Proposed Field: Edge Computing** | Core focus on Computer Networks, Wireless Sensor Networks, IoT Edge Systems | **Strong alignment** | Direct 100% domain overlap with Prof. Christian Rohner's active research portfolio and ongoing project grants. |
...
* **Professor's Expertise:** Prof. Christian Rohner's pioneering work in split computing and early-exit networks (Non-Negative Decomposition of Multivariate Information: From Minimum to Blackwell-Specific Information).
...
* **Professor's Expertise:** Prof. Christian Rohner's research in decentralized edge computing architectures (Non-Negative Decomposition of Multivariate Information: From Minimum to Blackwell-Specific Information).
...
* **Professor's Expertise:** Prof. Christian Rohner's focus on distributed machine learning and resource-adaptive optimization.
...
* **Professor's Expertise:** Prof. Christian Rohner's long-standing research into energy-constrained sensor networks and IoT optimization.
...
* **Professor's Expertise:** Prof. Christian Rohner's active research in real-time edge video stream analytics.
...
Prof. Christian Rohner's research is advancing toward fully autonomous, decentralized, and resource-efficient computing fabrics for next-generation distributed systems, emphasizing low-latency edge AI inference, resilient collaborative orchestration, and systems validation on physical hardware testbeds.

---

## 20. Photograph the Professor's Research Fit

| Dimension | Applicant Profile | Professor Prof. Christian Rohner | Evaluated Fit |
| :--- | :--- | :--- | :--- |
| **Degree Background** | Computer Engineering (BSc); Computer Science (MSc) | Professor of Computer Networks in Department of Information Technology | Strong Alignment |
| **Practical Engineering** | Software Engineering / iOS Engineering | Experimental testbeds in Computer Systems and Communication Research Group | High Value Complement |
| **Primary Research Field** | Edge Computing | Computer Networks, Wireless Sensor Networks | 100% Direct Match |
...
1. In your recent work on 'Non-Negative Decomposition of Multivariate Information: From Minimum to Blackwell-Specific Information', what is the primary systems bottleneck when scaling across heterogeneous devices with different neural hardware accelerators?
...
3. How are doctoral research topics typically structured in Computer Systems and Communication Research Group—do incoming PhD students formulate their own proposals or integrate into specific funded grant milestones?
...
7. What physical hardware testbeds (e.g. embedded GPU clusters, SDN switches, IoT sensor meshes) are currently most active in Computer Systems and Communication Research Group?
...
### Tier 1 — Must Read
1. *Non-Negative Decomposition of Multivariate Information: From Minimum to Blackwell-Specific Information* (Entropy, 2024)

### Tier 2 — Research Evolution
2. *Non-Negative Decomposition of Multivariate Information: From Minimum to Blackwell-Specific Information* (Entropy, 2024)

### Tier 3 — PhD Alignment
3. *Non-Negative Decomposition of Multivariate Information: From Minimum to Blackwell-Specific Information* (Entropy, 2024)
...
2. Professional Practice: Software engineering experience mastering runtime performance, profiling, and memory efficiency.
  ↓
3. Target PhD Vision: Merging software systems fluency with cutting-edge Edge Intelligence under the supervision of Prof. Christian Rohner.
```
...
* **University:** Uppsala University
* **Department:** Department of Information Technology
* **Laboratory:** Computer Systems and Communication Research Group
* **Associated Research Centers:** Uppsala Computing Systems Center (UPMARC), Centre for Interdisciplinary Mathematics
* **Hardware & Systems Testbeds:** Uppsala Wireless IoT Testbed
* **Graduate School:** [https://www.uu.se/en/admissions/doctoral-studies](https://www.uu.se/en/admissions/doctoral-studies)

---

## 29. Funding Opportunities, Pathways & Eligibility
* **Swedish Research Council (VR) Grant:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Doctoral positions in Sweden are classified as salaried empl | Deadline: Aligned with faculty recruitment cycle
* **Uppsala UPMARC Research Grant:** Provider: National Research Council / University Research Fund | Type: RESEARCH_GRANT | Stipend: Supports doctoral student stipends & hardware equipment | Tuition: Grant-supported doctoral positions | Duration: 3–5 Years | International Eligibility: ELIGIBLE | Dependant Support: Doctoral positions in Sweden are classified as salaried empl | Deadline: Aligned with faculty recruitment cycle
...
Prof. Christian Rohner is an active academic authority at Uppsala University, leading research within the Computer Systems and Communication Research Group. Over a prolific academic trajectory spanning from 2024 to 2024, Prof. Christian Rohner has pioneered systems-grounded solutions addressing foundational distributed systems, resource-constrained networking, and state-of-the-art Edge Intelligence architectures.

### One-Sentence Research Identity:
> "Prof. Christian Rohner is primarily a researcher in Computer Networks, with expertise spanning Wireless Sensor Networks, IoT Edge Systems, with recent work increasingly focused on Collaborative Edge Intelligence (Split Inference & Early-Exit DNNs)."
...
* **[FACT]** Official Faculty Profile: https://www.katalog.uu.se/profile/?id=N96-1845
* **[FACT]** Recruitment Verification Record: 'Recruiting PhD researchers with full Swedish salaried employment contracts through Uppsala IT doctoral program.' (Source: official_lab_website, Date: 2026-01-20)
